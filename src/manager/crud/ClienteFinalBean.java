...
public class ClienteFinalBean {
    ...
    private boolean novo, usuarioNovo, clienteAlterar;
...
//        }
     ...
     * @throws IOException
     */
    public void abrirNovoUsuario() throws IOException {
        usuarioNovo = true;
    ...
    public boolean isClienteAlterar() {
        return clienteAlterar;
    }
    
    public void setClienteAlterar(boolean clienteAlterar){
