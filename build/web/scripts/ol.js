...
(function (root, factory) {
    ...
    function Ma(a) {
        return function (c) {
            if (c)
                return[Da(c[0], a[0], a[2]), Da(c[1], a[1], a[3])]
        }
    }
    function Na(a) {
        return a
    ...
    function ab(a, c) {
        ...
        if (d) {
            for (var e = 0, f = d.length; e < f; ++e)
                a.removeEventListener(c, d[e].kg), Qa(d[e]);
            d.length = 0;
            if (d = a[Ua])
                delete d[c], 0 === Object.keys(d).length && delete a[Ua]
        }
    }
    function C(a, c, d, e, f) {
        var g = $a(a), h = g[c];
        h || (h = g[c] = []);
        (g = Ya(h, d, e, !1)) ? f || (g.lg = !1) : (g = {jg: e, lg: !!f, listener: d, target: a, type: c}, a.addEventListener(c, Va(g)), h.push(g));
        return g
    }
    function bb(a, c, d, e) {
        return C(a, c, d, e, !0)
    ...
    jb.prototype.b = function (a) {
        ...
        if (d) {
            ...
            if (0 === this.ya[a]) {
                c = this.Qa[a];
                for (delete this.Qa[a]; c--; )
                    this.removeEventListener(a, pa);
                delete this.ya[a]
            }
            return e
        }
    ...
    function Eb(a) {
        return function (c, d, e) {
            if (void 0 !== c)
                return c = vb(a, c, e), c = Da(c + d, 0, a.length - 1), a[c]
        }
    }
    function Fb(a, c, d) {
    ...
    ;
    function Vb(a) {
        for (var c = Wb(), d = 0, e = a.length; d < e; ++d)
            Xb(c, a[d]);
        return c
    }
    function Yb(a, c, d) {
    ...
    Cc.prototype.a = function (a) {
        for (var c = 0, d = a.length, e = a[d - 1][0], f = a[d - 1][1], g = 0; g < d; g++)
            var h = a[g][0], k = a[g][1], c = c + Ha(h - e) * (2 + Math.sin(Ha(f)) + Math.sin(Ha(k))), e = h, f = k;
    ...
    function Fc(a) {
        ...
        if ("function" == typeof e && void 0 === c[d]) {
            ...
            if (void 0 !== f) {
                ...
                for (var g in c)
                    c = e.defs(g), void 0 !== c && (a = Ic(g), c === f ? Jc([a, this]) : (c = e(g, d), Kc(a, this, c.forward, c.inverse)))
            }
        }
    }
    l = Fc.prototype;
    ...
    l.hd = function (a) {
        ...
        if (0 > a || 0 !== this.o && a <= this.o)
            return this;
        var c = a.toString();
        if (this.l.hasOwnProperty(c))
            return this.l[c];
        var d = this.Ic(a);
        if (d.ga().length < this.A.length)
            return this.l[c] = d;
        this.o = a;
        return this
    };
    ...
    function Bd(a, c, d, e, f, g, h, k, m, n, p) {
        ...
        for (var r = p ? p : [NaN, NaN], u = c + e; u < d; )
            if (yd(a, u - e, u, e, h, k, r), q = Ga(h, k, r[0], r[1]), q < n) {
                ...
                u += e * Math.max((Math.sqrt(q) - Math.sqrt(n)) / f | 0, 1);
    ...
    function Od(a, c, d, e, f, g) {
        if (0 === d.length || !Nd(a, c, d[0], e, f, g))
            return!1;
        var h;
        c = 1;
        for (h = d.length; c < h; ++c)
            if (Nd(a, d[c - 1], d[c], e, f, g))
                return!1;
        return!0
    }
    ;
    ...
    function Sd(a, c, d, e, f) {
        var g = d[0];
        if (!(Rd(a, c, g, e, f) || Nd(a, c, g, e, f[0], f[1]) || Nd(a, c, g, e, f[0], f[3]) || Nd(a, c, g, e, f[2], f[1]) || Nd(a, c, g, e, f[2], f[3])))
            return!1;
        if (1 === d.length)
            return!0;
        c = 1;
        for (g = d.length; c < g; ++c)
            if (Md(a, d[c - 1], d[c], e, f))
                return!1;
        return!0
    }
    ;
    ...
    function Yd(a, c, d, e) {
        ...
        var g;
        for (g = 0; g < f; ++g)
            xb(e, a.offset(c, d, 2 * Math.PI * g / f));
        e.push(e[0], e[1]);
        a = new F(null);
        a.ba("XY", e, [e.length]);
        return a
    ...
    function ae(a, c, d, e) {
        ...
        for (var n, p, q = 0; q <= m; ++q)
            p = q * h, n = e + 2 * Ja(q, m) * Math.PI / m, f[p] = c[0] + d * Math.cos(n), f[p + 1] = c[1] + d * Math.sin(n);
        a.ba(g, f, k)
    }
    ;
    function be(a) {
        ...
        if (void 0 !== a.resolutions)
            d = a.resolutions, e = d[0], f = d[d.length - 1], d = Eb(d);
        else {
            e = Xc(a.projection);
            f = e.O();
    ...
    l.Ze = function (a, c, d) {
        ...
        a = a.ua();
        for (var u = 0, v = k.length; u < v; u += a)
            var x = k[u] * e - k[u + 1] * m, z = k[u] * m + k[u + 1] * e,
    ...
    l.To = function (a, c) {
        var d = this.Zb();
        if (a < d)
            d = this.a[a], this.a[a] = c, this.b(new ve("remove", d, this)), this.b(new ve("add", c, this));
        else {
            for (; d < a; ++d)
                this.Zd(d, void 0);
            this.Zd(a, c)
    ...
    function Qe(a, c) {
        for (var d, e, f = 1; f < arguments.length; f++) {
            ...
            for (d in e)
                a[d] = e[d];
            for (var g = 0; g < Pe.length; g++)
                d = Pe[g], Object.prototype.hasOwnProperty.call(e, d) && (a[d] = e[d])
        }
    }
    ;
    ...
    function Af(a) {
        var c = Bf;
        if ("none" != (yf(a, "display") || (a.currentStyle ? a.currentStyle.display : null) || a.style && a.style.display))
            return c(a);
    ...
    Jf.prototype.setMap = function (a) {
        ...
        this.s.length = 0;
        if (this.a = a)
            (this.S ? this.S : a.v).appendChild(this.element), this.render !== pa && this.s.push(C(a, "postrender", this.render, this)), a.render()
    };
    ...
    l.forEach = function (a, c) {
        for (var d = this.b; d; )
            a.call(c, d.kc, d.Yb, this), d = d.xb
    };
    l.get = function (a) {
        a = this.f[a];
        if (a === this.a)
    ...
    Of.prototype.Gc = function (a) {
        for (var c, d; Pf(this) && !(c = this.b.kc, d = c.ja[0].toString(), d in a && a[d].contains(c.ja)); )
            fb(this.pop())
    };
    function Qf(a, c) {
        jb.call(this);
    ...
    function Zf(a, c) {
        for (var d = a.b.length, e = Array(d), f = a.minZoom; f < d; ++f)
            e[f] = bg(a, c, f);
        a.a = e
    }
    function hg(a) {
        var c = a.l;
        if (!c) {
            var c = ig(a), d = jg(c, void 0, void 0), c = new Yf({extent: c, origin: oc(c), resolutions: d, tileSize: void 0});
            a.l = c
        }
        return c
    }
    ...
    ;
    function lg(a) {
        Vf.call(this, {attributions: a.attributions, extent: a.extent, logo: a.logo, projection: a.projection, state: a.state, wrapX: a.wrapX});
    ...
    function mg(a, c, d, e, f) {
        ...
        for (var g = !0, h, k, m = e.b; m <= e.a; ++m)
            for (var n = e.g; n <= e.f; ++n)
                h = a.Ab(d, m, n), k = !1, Lf(c, h) && (h = c.get(h), (k = 2 === h.V()) && (k = !1 !== f(h))), k || (g = !1);
        return g
    }
    l.Od = function () {
        return 0
    ...
    function rg(a) {
        if (a = a.frameState) {
            ...
            c = c[1];
            for (var J in this.j)
                J in d ? (this.l[J] || (Cf(this.j[J], !0), this.l[J] = !0), delete d[J]) : J in c ? (this.l[J] && (Cf(this.j[J], !1), delete this.l[J]), delete c[J]) : (uf(this.j[J]), delete this.j[J], delete this.l[J]);
            for (J in d)
                e = document.createElement("LI"), e.innerHTML = d[J].a, this.M.appendChild(e), this.j[J] =
                        e, this.l[J] = !0;
            for (J in c)
                e = document.createElement("LI"), e.innerHTML = c[J].a, Cf(e, !1), this.M.appendChild(e), this.j[J] = e;
            ...
            J = this.T;
            for (ua in J)
                ua in a || (uf(J[ua]), delete J[ua]);
            for (var Ta in a)
                d = a[Ta], d instanceof HTMLElement && (this.v.appendChild(d), J[Ta] = d), Ta in J || (ua = new Image, ua.src = Ta, "" === d ? d = ua : (d = pf("A", {href: d}),
                        d.appendChild(ua)), this.v.appendChild(d), J[Ta] = d);
            Cf(this.v, !Sa(a))
        } else
            this.B && (Cf(this.element, !1), this.B = !1)
    }
    l = qg.prototype;
    l.Vl = function (a) {
        a.preventDefault();
    ...
    function tg(a) {
        ...
        d = pf("BUTTON", {"class": c + "-reset", type: "button", title: a.tipLabel ? a.tipLabel : "Reset rotation"}, this.f);
    ...
    tg.prototype.B = function (a) {
        ...
        if (void 0 !== this.o)
            ...
            if (c) {
                var d = c.Ka();
                void 0 !== d && (0 < this.j && (d %= 2 * Math.PI, d < -Math.PI && (d += 2 * Math.PI), d > Math.PI && (d -= 2 * Math.PI), a.Va(oe({rotation: d, duration: this.j, easing: je}))), c.de(0))
            }
        }
    };
    function ug(a) {
    ...
    function vg(a) {
        a = a ? a : {};
        var c = void 0 !== a.className ? a.className : "ol-zoom", d = void 0 !== a.delta ? a.delta : 1, e = void 0 !== a.zoomOutLabel ? a.zoomOutLabel : "\u2212", f = void 0 !== a.zoomOutTipLabel ? a.zoomOutTipLabel : "Zoom out", g = pf("BUTTON", {"class": c + "-in", type: "button", title: void 0 !== a.zoomInTipLabel ? a.zoomInTipLabel : "Zoom in"}, void 0 !== a.zoomInLabel ? a.zoomInLabel : "+");
    ...
    vg.prototype.l = function (a, c) {
        ...
        if (e) {
            var f = e.$();
            f && (0 < this.f && d.Va(pe({resolution: f, duration: this.f, easing: je})), d = e.constrainResolution(f, a), e.Qb(d))
        }
    };
    function wg(a) {
        a = a ? a : {};
    ...
    function Eg(a, c) {
        ...
        if (c && a.f) {
            ...
            if (e = a.a.Ma(c))
                a.l(e, e), d = (d = a.xg()) ? d(e) : e.toString()
        }
    ...
    var Ng = function () {
        ...
        return function () {
            if (void 0 === a) {
                ...
                for (var f in e)
                    f in c.style && (c.style[f] = "translate(1px,1px)", d = qa.getComputedStyle(c).getPropertyValue(e[f]));
        ...
        return function () {
            if (void 0 === a) {
                ...
                document.body.appendChild(c);
                for (var f in e)
                    f in c.style && (c.style[f] = "translate3d(1px,1px,1px)", d = qa.getComputedStyle(c).getPropertyValue(e[f]));
                document.body.removeChild(c);
                a = d && "none" !== d
            }
            return a
    ...
    var Tg, Ug = "undefined" !== typeof navigator ? navigator.userAgent.toLowerCase() : "", Vg = -1 !== Ug.indexOf("firefox"), Wg = -1 !== Ug.indexOf("safari") && -1 === Ug.indexOf("chrom"), Xg = -1 !== Ug.indexOf("macintosh"), Yg = qa.devicePixelRatio || 1, Zg = !1, $g = function () {
        ...
        try {
            ...
            fh = !1, gh, hh = [];
    if ("WebGLRenderingContext"in qa)
        try {
    ...
    ;
    function kh(a) {
        jh.call(this, a, {mousedown: this.nl, mousemove: this.ol, mouseup: this.rl, mouseover: this.ql, mouseout: this.pl});
        this.a = a.g;
        this.g = []
    }
    y(kh, jh);
    ...
    function vh(a) {
        jh.call(this, a, {MSPointerDown: this.wl, MSPointerMove: this.xl, MSPointerUp: this.Al, MSPointerOut: this.yl, MSPointerOver: this.zl, MSPointerCancel: this.vl, MSGotPointerCapture: this.tl, MSLostPointerCapture: this.ul});
        this.a = a.g;
    ...
    function xh(a) {
        jh.call(this, a, {pointerdown: this.eo, pointermove: this.fo, pointerup: this.jo, pointerout: this.ho, pointerover: this.io, pointercancel: this.co, gotpointercapture: this.Ck, lostpointercapture: this.ml})
    }
    y(xh, jh);
    l = xh.prototype;
    l.eo = function (a) {
    ...
    function Bh(a, c, d) {
        ...
        for (h = 0; h < g; ++h)
            k = Ah(a, c, f[h]), k.preventDefault = e, d.call(a, c, k)
    }
    l.mp = function (a) {
        ...
        if (0 === d || 1 === d && (1).toString()in this.a)
            this.g = c.identifier, void 0 !== this.f && qa.clearTimeout(this.f);
        Ch(this, a);
        this.i++;
        Bh(this, a, this.Zn)
    };
    ...
    function Gh(a) {
        ...
        a = this.a.length;
        for (var c, d = 0; d < a; d++)
            c = this.a[d], Ih(this, Object.keys(c.c))
    }
    y(Gh, jb);
    function Hh(a, c) {
    ...
    function nh(a, c) {
        for (var d = {}, e, f = 0, g = Kh.length; f < g; f++)
            e = Kh[f][0], d[e] = a[e] || c[e] || Kh[f][1];
        return d
    }
    ...
    Gh.prototype.fa = function () {
        for (var a = this.a.length, c, d = 0; d < a; d++)
            c = this.a[d], Jh(this, Object.keys(c.c));
        Gh.ia.fa.call(this)
    };
    ...
    var Sh = "singleclick", Qh = "click", Rh = "dblclick", Yh = "pointerdrag", Xh = "pointermove", Wh = "pointerdown", Uh = "pointerup", Vh = "pointercancel", Zh = {Gp: Sh, vp: Qh, wp: Rh, zp: Yh, Cp: Xh, yp: Wh, Fp: Uh, Ep: "pointerover", Dp: "pointerout", Ap: "pointerenter", Bp: "pointerleave", xp: Vh};
    function $h(a) {
        pb.call(this);
        var c = Pa({}, a);
    ...
    function ai(a) {
        ...
        return{layer: a, opacity: Da(c, 0, 1), R: d, visible: e, Lc: !0, extent: f, zIndex: g, maxResolution: h, minResolution: Math.max(k, 0)}
    }
    l = $h.prototype;
    l.O = function () {
    ...
    function si(a, c, d, e, f, g, h, k, m, n) {
        ...
        for (B = h; B >= r; --B)
            for (v = bg(d, g, B, v), x = d.$(B), z = v.b; z <= v.a; ++z)
                for (E = v.g; E <= v.f; ++E)
                    h - B <= k ? (u = c.Wb(B, z, E, e, f), 0 == u.V() && (q[u.ja.toString()] = !0, u.gb()in a.g || a.f([u, p, fg(d, u.ja), x])), void 0 !== m && m.call(n, u)) : c.Uf(B, z, E, f)
    }
    ;
    function ti(a) {
        this.v = a.opacity;
    ...
    function ui(a) {
        ...
        ti.call(this, {opacity: void 0 !== a.opacity ? a.opacity : 1, rotation: void 0 !== a.rotation ? a.rotation : 0, scale: void 0 !== a.scale ? a.scale : 1, snapToPixel: void 0 !== a.snapToPixel ? a.snapToPixel : !0, rotateWithView: void 0 !== a.rotateWithView ? a.rotateWithView : !1})
    }
    y(ui, ti);
    l = ui.prototype;
    l.Tb = function () {
    ...
    wi.prototype.U = function () {
        ...
        if (!this.s && null !== this.l) {
            ...
            for (var c = a.getImageData(0, 0, this.a.width, this.a.height), d = c.data, e = this.l[0] / 255, f = this.l[1] / 255, g = this.l[2] / 255, h = 0, k = d.length; h < k; h += 4)
    ...
    function Ai() {
        ...
        if (32 < a.a) {
            var c = 0, d, e;
            for (d in a.b)
                e = a.b[d], 0 !== (c++ & 3) || lb(e) || (delete a.b[d], --a.a)
        }
    }
    l.oa = function (a, c, d, e, f, g) {
        ...
        for (q = p.length - 1; 0 <= q; --q) {
            var u = p[q], r = u.layer;
            if (ei(u, n) && f.call(g, r) && (u = Bi(this, r), r.da() && (k = u.oa(r.da().N ? m : a, c, h, e)), k))
                return k
        }
    };
    l.mh = function (a, c, d, e, f, g) {
        ...
        for (n = m.length - 1; 0 <= n; --n) {
            h = m[n];
            var p = h.layer;
            if (ei(h, k) && f.call(g, p) && (h = Bi(this, p).xc(a, c, d, e)))
                return h
        }
    };
    ...
    function Hi(a) {
        ...
        for (k = 0; k < g; ++k)
            h = d[k], m = c(h), Infinity == m ? delete a.g[a.l(h)] : (e[f] = m, d[f++] = h);
        d.length = f;
        e.length = f;
    ...
    Ii.prototype.o = function (a) {
        ...
        var c = a.V();
        if (2 === c || 3 === c || 4 === c || 5 === c)
            cb(a, "change", this.o, this), a = a.gb(), a in this.c && (delete this.c[a], --this.i), this.s()
    };
    function Ji(a, c, d) {
        for (var e = 0, f, g; a.i < c && e < d && 0 < a.rc(); )
            f = Ei(a)[0], g = f.gb(), 0 !== f.V() || g in a.c || (a.c[g] = !0, ++a.i, ++e, f.load())
    }
    ;
    function Ki(a, c, d) {
        this.f = a;
    ...
    function Li(a, c) {
        ...
        return ne({source: c, duration: g, easing: function (a) {
    ...
    function Ni(a, c, d, e, f) {
        if (void 0 !== d) {
            var g = c.Ka(), h = c.bb();
            void 0 !== g && h && f && 0 < f && (a.Va(oe({rotation: g, duration: f, easing: je})), e && a.Va(ne({source: h, duration: f, easing: je})));
            c.rotate(d, e)
        }
    }
    ...
    function Pi(a, c, d, e, f) {
        if (d) {
            var g = c.$(), h = c.bb();
            void 0 !== g && h && d !== g && f && 0 < f && (a.Va(pe({resolution: g, duration: f, easing: je})), e && a.Va(ne({source: h, duration: f, easing: je})));
            if (e) {
                var k;
                a = c.bb();
                f = c.$();
    ...
    function bj(a) {
        ...
        var c = !1, d = a.type;
        if (d === Wh || d === Yh || d === Uh)
            d = a.b, a.type == Uh ? delete this.ea[d.pointerId] : a.type == Wh ? this.ea[d.pointerId] = d : d.pointerId in this.ea && (this.ea[d.pointerId] = d), this.o = Ra(this.ea);
    ...
    function wj(a) {
        ...
        if ("keydown" == a.type) {
            ...
            if (this.c(a) && (40 == d || 37 == d || 39 == d || 38 == d)) {
                ...
                f = this.o;
                if (g = c.bb())
                    f && 0 < f && e.Va(ne({source: g, duration: f, easing: le})), e = c.Kd([g[0] + d[0], g[1] + d[1]]), c.jb(e);
                a.preventDefault();
                c = !0
            }
        }
    ...
    function Jj(a) {
        ...
        (void 0 !== a.doubleClickZoom ? a.doubleClickZoom : 1) && c.push(new Qi({delta: a.zoomDelta, duration: a.zoomDuration}));
        ...
        if (void 0 !== a.keyboard ? a.keyboard : 1)
            c.push(new vj), c.push(new xj({delta: a.zoomDelta,
    ...
    l.Pk = function () {
        ...
        c = 0;
        for (d = a.length; c < d; c++)
            e = a[c], this.a[w(e).toString()] = [C(e, "propertychange", this.Xd, this), C(e, "change", this.Xd, this)];
        this.u()
    };
    l.Ok = function (a) {
        a = a.element;
    ...
    l.df = function (a) {
        ...
        var e, f;
        for (e = c.length; d < e; d++)
            f = c[d], f.opacity *= a.opacity, f.visible = f.visible && a.visible, f.maxResolution = Math.min(f.maxResolution, a.maxResolution), f.minResolution = Math.max(f.minResolution, a.minResolution), void 0 !== a.extent && (f.extent = void 0 !== f.extent ? vc(f.extent, a.extent) : a.extent);
        return c
    };
    l.ff = function () {
        return"ready"
    ...
    function Qj(a, c) {
        Fc.call(this, {code: a, units: "degrees", extent: Rj, axisOrientation: c, global: !0, metersPerUnit: Sj, worldExtent: Rj})
    }
    y(Qj, Fc);
        ...
        if (void 0 === a.l) {
            ...
            if (8192 >= c.length)
                ...
                for (d = "", e = 0; e < c.length; e += 8192)
                    f = Be(c, e, e + 8192), d += String.fromCharCode.apply(null, f);
            a.l = d
        }
        return a.l
    }
    ...
    function ik(a) {
        ...
        if (void 0 === c)
            c = Mg(h, h), this.f = c.canvas, d = h = this.f.width, this.Bh(f, c, 0, 0), this.g ? this.l = this.f : (c = Mg(f.size, f.size), this.l = c.canvas, this.Ah(f, c, 0, 0));
        else {
            h = Math.round(h);
        ...
        this.N = [h, h];
        this.s = [d, d];
        ti.call(this, {opacity: 1, rotateWithView: !1, rotation: 0, scale: 1, snapToPixel: void 0 !== a.snapToPixel ?
                    a.snapToPixel : !0})
    }
    y(ik, ti);
    l = ik.prototype;
    ...
    function ok() {
        ...
        a.Point = [new jk({image: new ik({radius: 6, fill: new ak({color: d}), stroke: new gk({color: c, width: 1.5})}), zIndex: Infinity})];
    ...
    function sk(a, c, d, e) {
        ...
        if (a.T && "" !== a.g) {
            ...
            k ? (k.font != g.font && (k.font = h.font = g.font), k.textAlign != g.textAlign && (k.textAlign = h.textAlign = g.textAlign), k.textBaseline != g.textBaseline && (k.textBaseline = h.textBaseline = g.textBaseline)) : (h.font = g.font, h.textAlign = g.textAlign, h.textBaseline = g.textBaseline, a.ea = {font: g.font, textAlign: g.textAlign, textBaseline: g.textBaseline});
    ...
    l.Ob = function (a, c) {
        ...
        if (c) {
            ...
            this.b = {lineCap: void 0 !== e ? e : "round", lineDash: f ? f : Xj, lineJoin: void 0 !== g ? g : "round", lineWidth: this.B * (void 0 !== h ? h : 1), miterLimit: void 0 !== k ? k : 10, strokeStyle: He(d ? d : Yj)}
        } else
            this.b = null
    };
    l.Pb = function (a) {
    ...
    l.Rb = function (a) {
        if (a) {
            ...
            if (d) {
                ...
                this.s = {lineCap: void 0 !== e ? e : "round", lineDash: f ? f : Xj, lineJoin: void 0 !== g ? g : "round", lineWidth: void 0 !== h ? h : 1, miterLimit: void 0 !== d ? d : 10, strokeStyle: He(c ? c : Yj)}
            } else
                this.s = null;
    ...
    function Hk(a, c, d, e, f, g) {
        ...
        for (q = d + f; q < e; q += f)
            n[0] = c[q], n[1] = c[q + 1], u = dc(k, n), u !== r ? (p && (a.coordinates[h++] = m[0], a.coordinates[h++] = m[1]), a.coordinates[h++] = n[0], a.coordinates[h++] = n[1], p = !1) : 1 === u ? (a.coordinates[h++] = n[0], a.coordinates[h++] = n[1], p = !1) : p = !0, m[0] = n[0], m[1] = n[1], r = u;
            ...
            switch (A[0]) {
                ...
                case 5:
                    ...
                    for (O = A[9]; r < u; r += 2) {
                        ...
                        R = n[r + 1] + J;
                        if (1 != B || 0 !== E)
                            hi(v, A, R, B, B, E, -A, -R), c.transform(v[0], v[1], v[4], v[5], v[12], v[13]);
                        ua = L.split("\n");
                        Ta = ua.length;
                        1 < Ta ? (kb = Math.round(1.5 * c.measureText("M").width), R -= (Ta - 1) / 2 * kb) : kb = 0;
                        for (Ka = 0; Ka < Ta; Ka++)
                            Ia = ua[Ka], O && c.strokeText(Ia, A, R), G && c.fillText(Ia, A, R), R += kb;
                        if (1 != B || 0 !== E)
                            nd(v, a), c.transform(a[0], a[1], a[4], a[5], a[12], a[13])
                    }
                    ++p;
                    break;
                case 6:
                ...
                case 8:
                    ...
                    B = R + .5 | 0;
                    if (E !== x || B !== z)
                        c.moveTo(A, R), x = E, z = B;
                    for (r += 2; r < u; r += 2)
                        if (A = n[r], R = n[r + 1], E = A + .5 | 0, B = R + .5 | 0, E !== x || B !== z)
                            c.lineTo(A, R), x = E, z = B;
                    ++p;
                    break;
                case 9:
                    c.fillStyle = A[1];
    ...
    function Nk(a, c, d) {
        Gk.call(this, a, c, d);
        this.g = {ad: void 0, Wc: void 0, Xc: null, Yc: void 0, Zc: void 0, $c: void 0, jf: 0, strokeStyle: void 0, lineCap: void 0, lineDash: null, lineJoin: void 0, lineWidth: void 0, miterLimit: void 0}
    }
    y(Nk, Gk);
    ...
    function Qk(a, c, d) {
        Gk.call(this, a, c, d);
        this.g = {qg: void 0, ad: void 0, Wc: void 0, Xc: null, Yc: void 0, Zc: void 0, $c: void 0, fillStyle: void 0, strokeStyle: void 0, lineCap: void 0, lineDash: null, lineJoin: void 0, lineWidth: void 0, miterLimit: void 0}
    }
    y(Qk, Gk);
    ...
    l.Ye = function (a, c) {
        var d = this.g, e = d.strokeStyle;
        if (void 0 !== d.fillStyle || void 0 !== e)
            Sk(this), Ik(this, c), this.b.push([9, He(Wj)]), void 0 !== d.strokeStyle && this.b.push([10, d.strokeStyle, d.lineWidth, d.lineCap, d.lineJoin, d.miterLimit, d.lineDash]), d = a.zb(), e = a.Kb(), Rk(this, e, 0, d, a.ua()), Lk(this, c)
    };
    l.Xe = function (a, c) {
        var d = this.g, e = d.strokeStyle;
        if (void 0 !== d.fillStyle || void 0 !== e) {
    ...
    function Uk(a, c, d, e, f) {
        if ("" !== a.o && a.l && (a.g || a.i)) {
            ...
            a.i && (g = a.i, h = a.M, h && h.lineCap == g.lineCap && h.lineDash == g.lineDash && h.lineJoin == g.lineJoin && h.lineWidth == g.lineWidth && h.miterLimit == g.miterLimit && h.strokeStyle == g.strokeStyle || (k = [10, g.strokeStyle, g.lineWidth, g.lineCap, g.lineJoin, g.miterLimit, g.lineDash, !1], a.a.push(k), a.b.push(k), h ? (h.lineCap =
                    g.lineCap, h.lineDash = g.lineDash, h.lineJoin = g.lineJoin, h.lineWidth = g.lineWidth, h.miterLimit = g.miterLimit, h.strokeStyle = g.strokeStyle) : a.M = {lineCap: g.lineCap, lineDash: g.lineDash, lineJoin: g.lineJoin, lineWidth: g.lineWidth, miterLimit: g.miterLimit, strokeStyle: g.strokeStyle}));
            g = a.l;
            h = a.N;
    ...
    Tk.prototype.Rb = function (a) {
        if (a) {
            ...
            g = void 0 !== g ? g : "center";
            k = void 0 !== k ? k : "middle";
            this.l ? (m = this.l, m.font = a, m.textAlign = g, m.textBaseline = k) : this.l = {font: a, textAlign: g, textBaseline: k};
            this.o = void 0 !== d ? d : "";
            this.j = void 0 !== c ? c : 0;
            this.s = void 0 !== e ? e : 0;
            this.v = void 0 !== f ? f : 0;
    ...
    Vk.prototype.Pa = function (a, c, d, e, f, g) {
        ...
        for (var q, r, m = 0, n = h.length; m < n; ++m)
            for (q = this.a[h[m].toString()], p = 0, k = g.length; p < k; ++p)
                r = q[g[p]], void 0 !== r && r.Pa(a, c, d, e, f);
        a.restore()
    };
    function Xk(a, c, d, e, f, g, h) {
        ...
        for (n = k.length; m < n; ++m)
            for (q = a.a[k[m].toString()], p = Fk.length - 1; 0 <= p; --p)
                if (r = q[Fk[p]], void 0 !== r && (r = Jk(r, c, 1, d, e, f, r.b, g, h)))
                    return r
    }
    ...
    function bl(a, c, d, e, f, g) {
        var h = !1, k, m;
        if (k = d.a)
            m = k.od(), 2 == m || 3 == m ? k.Tf(f, g) : (0 == m && k.load(), k.kf(f, g), h = !0);
        if (f = (0, d.g)(c))
            e = f.hd(e), (0, cl[e.X()])(a, e, d, c);
        return h
    }
    var cl = {Point: function (a, c, d, e) {
            var f = d.a;
            if (f) {
                if (2 != f.od())
                    return;
            ...
            if (f = d.Ea())
                a = a.b(d.b, "Text"), a.Rb(f), Uk(a, c.ga(), 2, 2, e)
            ...
            if (f = d.Ea())
                a = a.b(d.b, "Text"), a.Rb(f), Uk(a, xk(c), 2, 2, e)
            ...
            if (f = d.Ea())
                a = a.b(d.b, "Text"), a.Rb(f), Uk(a, Xd(c), 2, 2, e)
            ...
            if (f = d.Ea())
                a = a.b(d.b, "Text"), a.Rb(f), d = c.ga(), Uk(a, d, d.length, c.ua(), e)
            ...
            if (f = d.Ea())
                a = a.b(d.b, "Text"), a.Rb(f), c = yk(c), Uk(a, c, c.length, 2, e)
            ...
            if (f = d.Ea())
                a = a.b(d.b, "Text"), a.Rb(f), c = Ak(c), Uk(a, c, c.length, 2, e)
            ...
            if (f = d.Ea())
                a = a.b(d.b, "Text"), a.Rb(f), Uk(a, c.ld(), 2, 2, e)
        }};
        ...
        k.f.forEach(function (a) {
            ...
            a:{
                ...
                for (m = 0; m < k; m++) {
                    ...
                    h[m] = kb;
                    for (n = m + 1; n < k; n++)
                        for (kb = - h[n][m] / h[m][m], Ka = m; Ka < k + 1; Ka++)
                            h[n][Ka] = m == Ka ? 0 : h[n][Ka] + kb * h[m][Ka]
                }
                m = Array(k);
                for (n = k - 1; 0 <= n; n--)
                    for (m[n] = h[n][k] / h[n][n], kb = n - 1; 0 <= kb; kb--)
                        h[kb][k] -= h[kb][n] * m[n];
                h = m
            }
    ...
    function nl(a, c, d, e, f, g, h, k, m, n) {
        ...
        if (0 < n) {
            if (a.c.g && a.l)
                var v = Vb([c, d, e, f]), u = u | .25 < rc(v) / a.l;
            !r && a.g.g && q && (u |= .25 < q)
        }
        if (u || !a.i || wc(p, a.i)) {
    ...
    ql.prototype.ud = function () {
        var a = this.nb.V();
        2 == a && (this.i = ll(rc(this.g) / this.c, sc(this.g) / this.c, this.j, this.nb.$(), 0, this.c, this.g, this.o, [{extent: this.nb.O(), image: this.nb.a()}], 0));
        this.state = a;
        gi(this)
    };
    ql.prototype.load = function () {
        if (0 == this.state) {
            ...
            2 == a || 3 == a ? this.ud() : (this.vd = C(this.nb, "change", function () {
                var a = this.nb.V();
                if (2 == a || 3 == a)
                    Xa(this.vd), this.vd = null, this.ud()
            }, this), this.nb.load())
        }
    };
    function rl(a) {
        Vf.call(this, {attributions: a.attributions, extent: a.extent, logo: a.logo, projection: a.projection, state: a.state});
    ...
    rl.prototype.B = function (a, c, d, e) {
        ...
        if (f && e && !Zc(f, e)) {
            if (this.a) {
                if (this.na == this.g && Zc(this.a.v, e) && this.a.$() == c && this.a.f == d && ic(this.a.O(), a))
                    return this.a;
                fb(this.a);
                this.a = null
            }
    ...
    function yl(a) {
        rl.call(this, {attributions: a.attributions, logo: a.logo, projection: a.projection, resolutions: a.resolutions, state: a.state});
    ...
    yl.prototype.Hc = function (a, c, d, e) {
        c = sl(this, c);
        var f = this.T;
        if (f && this.Y == this.g && f.$() == c && f.f == d && cc(f.O(), a))
            return f;
        a = a.slice();
        yc(a, this.ta);
            ...
            c.prototype = {all: function () {
                    ...
                    for (var f = [], g, h, k, m; c; ) {
                        ...
                        for (h = c.children.length; g < h; g++)
                            k = c.children[g], m = c.Ja ? e(k) : k.bbox, p(a, m) && (c.Ja ? d.push(k) : n(a, m) ? this.Zf(k, d) : f.push(k));
                        c = f.pop()
                    }
                    return d
                }, load: function (a) {
                    ...
                    if (g <= h)
                        return k = {children: a.slice(c, e + 1), height: 1, bbox: null, Ja: !0}, d(k, this.ib), k;
                    ...
                    for (q(a, c, e, h, this.Re); c <= e; c += h)
                        for (n = Math.min(c + h - 1, e), q(a, c, n, g, this.Se), m = c; m <= n; m += g)
                            p = Math.min(m + g - 1, n), k.children.push(this.ag(a, m, p, f - 1));
                    d(k, this.ib);
                    return k
                }, ej: function (a, c, d, e) {
                    ...
                    g.children.push(a);
                    for (f(g.bbox, d); 0 <= c; )
                        if (e[c].children.length > this.Pe)
                            this.nj(e, c), c--;
                        else
                            break;
                    this.bj(d, e, c)
                    ...
                    n = p = Infinity;
                    for (f = c; f <= d - c; f++)
                        g = e(a, 0, f, this.ib), h = e(a, f, d, this.ib), m = Math.max(0, Math.min(g[2], h[2]) - Math.max(g[0], h[0])) * Math.max(0, Math.min(g[3], h[3]) - Math.max(g[1], h[1])), g = k(g) + k(h), m < n ? (n = m, q = f, p = g < p ? g : p) : m === n && g < p && (p = g, q = f);
                    return q
                }, cj: function (a, c, d) {
                    ...
                    for (var c = a.length - 1, e; 0 <= c; c--)
                        0 === a[c].children.length ? 0 < c ? (e = a[c - 1].children, e.splice(e.indexOf(a[c]), 1)) : this.clear() : d(a[c], this.ib)
                }, hj: function (a) {
                    var c =
                            ["return a", " - b", ";"];
    ...
    function Q(a) {
        a = a || {};
        Vf.call(this, {attributions: a.attributions, logo: a.logo, projection: void 0, state: "ready", wrapX: void 0 !== a.wrapX ? a.wrapX : !0});
        this.S = pa;
        this.na = a.format;
        this.T = a.url;
    ...
    function hm(a, c) {
        ...
        e = 0;
        for (f = c.length; e < f; e++)
            g = c[e], d = w(g).toString(), jm(a, d, g) && k.push(g);
        e = 0;
    ...
    function om(a) {
        ...
        this.j = [0, 0];
        this.v = null;
        yl.call(this, {attributions: a.attributions, canvasFunction: this.zj.bind(this), logo: a.logo, projection: a.projection, ratio: a.ratio, resolutions: a.resolutions, state: this.c.V()});
        this.S = null;
        this.s = void 0;
        this.sh(a.style);
            ...
            if (!(e = h)) {
                ...
                if (f) {
                    ...
                    for (p = f.length; e < p; ++e)
                        q = bl(g, a, f[e], al(c, d), this.Ym, this) || q;
                    e = q
                } else
                    e = !1
            }
        ...
        if (this.f && this.f.a())
            if (this.a.da()instanceof om) {
                if (a = a.slice(), ji(c.pixelToCoordinateMatrix, a, a), this.oa(a, c, Ac, this))
                    return d.call(e, this.a)
            } else if (this.c || (this.c = hd(), nd(this.s, this.c)), c = [0, 0], ji(this.c, a, c), this.o || (this.o = Mg(1, 1)), this.o.clearRect(0, 0, 1, 1), this.o.drawImage(this.f ? this.f.a() : null, c[0], c[1], 1, 1, 0, 0, 1, 1), 0 < this.o.getImageData(0, 0, 1, 1).data[3])
                return d.call(e, this.a)
    };
    ...
    function sm(a, c, d, e) {
        ...
        if (g || r)
            z = a.c, E = z.canvas, G = gg(x, m), A = u.Ud(G, f, k), G = Uf(x.Ha(G)), A = A[0] / G[0], m = c.canvas.width * A, B = c.canvas.height * A, G = Math.round(Math.sqrt(m * m + B * B)), E.width != G ? E.width = E.height = G : z.clearRect(0, 0, G, G), E = (G - m) / 2 / A, B = (G - B) / 2 / A, n *= A, p = Math.round(A * (p + E)), q = Math.round(A * (q + B));
        m = z.globalAlpha;
    ...
    tm.prototype.i = function (a, c, d) {
        ...
        if (q && !q.Sa()) {
            ...
            if (n.N && k.a && !cc(m, e)) {
                ...
                m[0]; )
                    --x, p = n * x, p = Ek(this, a, p), q.Pa(r, f, p, h, g), k += n;
                x = 0;
                for (k = e[2]; k > m[2]; )
                    ++x, p = n * x, p = Ek(this, a, p), q.Pa(r, f, p, h, g), k -= n;
                p = Ek(this, a, 0)
    ...
    tm.prototype.l = function (a) {
                ...
                if (c) {
                    ...
                    if (Array.isArray(c))
                        for (var f = 0, g = c.length; f < g; ++f)
                            e = bl(r, a, c[f], al(n, p), this.N, this) || e;
                    else
                        e = bl(r, a, c, al(n, p), this.N, this) || e;
                    a = e
                } else
                    a = !1;
                this.c = this.c || a
        ...
        if (!this.c && this.B == n && this.M == g && this.U == h && cc(this.v, m))
            return!0;
        this.o = null;
        this.c = !1;
    ...
    function wm(a) {
        return 1 === a.length ? a[0] : function (c, d, e) {
            if (c)
                return a[Ja((c[1] << c[0]) + c[2], a.length)](c, d, e)
        }
    }
    function xm() {}
    function ym(a) {
    ...
    ;
    function zm(a) {
        lg.call(this, {attributions: a.attributions, cacheSize: a.cacheSize, extent: a.extent, logo: a.logo, opaque: a.opaque, projection: a.projection, state: a.state, tileGrid: a.tileGrid, tilePixelRatio: a.tilePixelRatio, wrapX: a.wrapX});
    ...
    Em.prototype.i = function (a, c, d) {
        ...
        if ("image" !== f) {
            ...
            for (B =
                    c.length; E < B; ++E)
                A = c[E], L = A.f, G = r.Ba(A.ja, this.j), z = A.ja[0], O = "tile-pixels" == A.o.vb(), z = r.$(z), R = z / u, z = Math.round(h * q[0] / 2), A = Math.round(h * q[1] / 2), O ? (G = oc(G), G = hi(this.v, z, A, m * R, m * R, p, (G[0] - n[0]) / R, (n[1] - G[1]) / R)) : G = v, Zj(g, -p, z, A), L.td.Pa(g, h, G, p, k, f), Zj(g, p, z, A);
                ...
                if (c) {
                    ...
                    if (Array.isArray(c))
                        for (var h = 0, k = c.length; h < k; ++h)
                            g = bl(e, a, c[h], d, this.B, this) || g;
                    else
                        g = bl(e, a, c, d, this.B, this) || g;
                    a = g
                } else
                    a = !1;
                this.U = this.U || a;
    ...
    Em.prototype.oa = function (a, c, d, e) {
        ...
        for (v = m.length; u < v; ++u)
            z = m[u], r = z.ja, x = n.tileGrid.Ba(r, this.j), ac(x, a) && ("tile-pixels" === z.o.vb() ? (x = oc(x), g = n.Xb(f), r = p.$(r[0]) / g, r = [(a[0] - x[0]) / r, (x[1] - a[1]) / r]) : r = a, z = z.f.td, q = q || z.oa(r, g, c, {}, function (a) {
                var c = w(a).toString();
                if (!(c in k))
    ...
    Gm.prototype.xe = function (a) {
        if (a) {
            ...
            for (m = g.length; k < m; ++k)
                p = g[k], n = p.layer, n = Bi(this, n), ei(p, h) && "ready" == p.R && n.l(a, p) && n.i(a, p, c);
            Zj(c, -f, e / 2, d / 2);
    ...
    Km.prototype.uf = function (a, c) {
        if (!c.visible)
            return this.c && (Cf(this.target, !1), this.c = !1), !0;
            ...
            if (L = m[R], x = this.f[L], L in u)
                if (B = x.$(), O = x.Fa(), hi(G, a.size[0] / 2, a.size[1] / 2, B / e.resolution, B / e.resolution, e.rotation, (O[0] - q[0]) / B, (q[1] - O[1]) / B), x.setTransform(G), L in v) {
                    ...
                    if (!a.viewHints[0] && !a.viewHints[1]) {
                        ...
                        B = O = void 0;
                        for (B in x.a)
                            O = x.a[B], A.contains(O.ja) || L.push(O);
                        Wa = A = void 0;
                        A = 0;
                        for (Wa = L.length; A < Wa; ++A)
                            O = L[A], B = O.ja.toString(), uf(O.ab(x)), delete x.a[B]
                    }
                }
            else
                uf(x.target), delete this.f[L];
    ...
    l.uf = function (a) {
        function c(a) {
            ...
            if (c) {
                if (c) {
                    ...
                    if (Array.isArray(c))
                        for (var f = 0, g = c.length; f < g; ++f)
                            e = bl(p, a, c[f], al(m, n), this.ph, this) || e;
                    else
                        e = bl(p, a, c, al(m, n), this.ph, this) || e;
                    a = e
                } else
                    a = !1;
                this.f = this.f || a
        ...
        void 0 ===
                h && (h = $k);
        g = Yb(g, k * m);
        if (!this.f && this.s == m && this.l == a && this.j == h && cc(this.o, g))
            return!0;
        this.c = null;
        this.f = !1;
    ...
    Om.prototype.xe = function (a) {
        if (a) {
            ...
            e = 0;
            for (f = c.length; e < f; ++e)
                h = c[e], g = h.layer, g = Bi(this, g), tf(this.b, g.target, e), ei(h, d) && "ready" == h.R ? g.uf(a, h) && g.oh(a, h) : g.Id();
            var c = a.layerStates, k;
            for (k in this.g)
                k in c || (g = this.g[k], uf(g.target));
    ...
    function hn(a, c, d, e) {
        ...
        for (A = 0; A < d; A += e)
            R = c[A] - a.j[0], Wa = c[A + 1] - a.j[1], G = B / 8, O = -v * f, L = -v * (h - g), a.b[B++] = R, a.b[B++] = Wa, a.b[B++] = O * z - L * u, a.b[B++] = O * u + L * z, a.b[B++] = p / m, a.b[B++] = (q + h) / k, a.b[B++] = n, a.b[B++] = r, O = v * (x - f), L = -v * (h - g), a.b[B++] = R, a.b[B++] = Wa, a.b[B++] = O * z - L * u, a.b[B++] = O * u + L * z, a.b[B++] = (p + x) / m, a.b[B++] = (q + h) / k, a.b[B++] = n, a.b[B++] = r, O = v * (x - f), L =
    ...
    function kn(a, c, d, e) {
        ...
        for (h = 0; h < k; ++h)
            f = c[h], g = w(f).toString(), g in d ? f = d[g] : (f = en(e, f), d[g] = f), a[h] = f
    }
    fn.prototype.Pa = function (a, c, d, e, f, g, h, k, m, n, p) {
        ...
        if (void 0 === m)
            ...
            if (n)
                ...
                g.clear(g.COLOR_BUFFER_BIT | g.DEPTH_BUFFER_BIT), ln(this, g, a, k, this.l, this.i), k = (k = m(null)) ? k : void 0;
            u = k
        }
    ...
    mn.prototype.Pa = function (a, c, d, e, f, g, h, k) {
        var m, n, p;
        m = 0;
        for (n = Fk.length; m < n; ++m)
            p = this.a[Fk[m]], void 0 !== p && p.Pa(a, c, d, e, f, g, h, k, void 0, !1)
    };
    function qn(a, c, d, e, f, g, h, k, m, n, p) {
        var q = rn, r, u;
        for (r = Fk.length - 1; 0 <= r; --r)
            if (u = a.a[Fk[r]], void 0 !== u && (u = u.Pa(c, d, e, f, q, g, h, k, m, n, p)))
                return u
    }
    ...
    An.prototype.xc = function (a, c, d, e) {
        if (this.c && this.c.a())
            if (this.a.da()instanceof om) {
                ...
                ji(this.j, a, c);
                if (!(0 > c[0] || c[0] > f[0] || 0 >
                c[1] || c[1] > f[1]) && (this.o || (this.o = Mg(1, 1)), this.o.clearRect(0, 0, 1, 1), this.o.drawImage(this.c.a(), c[0], c[1], 1, 1, 0, 0, 1, 1), 0 < this.o.getImageData(0, 0, 1, 1).data[3]))
                    return d.call(e, this.a)
            }
    };
    function Dn() {
    ...
    l.wf = function (a, c, d) {
        ...
        q = dg(n, E, q);
        if (this.o && se(this.o, q) && this.j == m.g)
            v = this.B;
        else {
            ...
            for (ua = q.b; ua <= q.a; ++ua)
                for (Ta = q.g; Ta <= q.f; ++Ta) {
                    G =
                            m.Wb(p, ua, Ta, u, h);
                    if (void 0 !== c.extent && (J = n.Ba(G.ja, O), !wc(J, c.extent)))
                        continue;
                    J = G.V();
                    J = 2 == J || 4 == J || 3 == J && !R;
                    !J && G.a && (G = G.a);
            ...
            for (var L = new Float32Array(4), kb, Ka, Ia, R = 0, Wa = c.length; R < Wa; ++R)
                for (kb in Ka = d[c[R]], Ka)
                    G = Ka[kb], J = n.Ba(G.ja, O), ua = 2 * (J[2] - J[0]) / B, Ta = 2 * (J[3] - J[1]) / B, Ia = 2 * (J[0] - v[0]) / B - 1,
    ...
    l.wf = function (a, c, d) {
                ...
                if (c) {
                    ...
                    if (Array.isArray(c))
                        for (var e = 0, g = c.length; e < g; ++e)
                            d = bl(r, a, c[e], al(n, p), this.rh, this) || d;
                    else
                        d = bl(r, a, c, al(n, p), this.rh, this) || d;
                    a = d
                } else
                    a = !1;
                this.j = this.j || a
        ...
        void 0 ===
                m && (m = $k);
        h = Yb(h, q * n);
        if (!this.j && this.N == n && this.R == k && this.M == m && cc(this.B, h))
            return!0;
    ...
    function Jn(a, c) {
        ...
        this.M = Mg();
        this.j = !0;
        this.f = Sg(this.b, {antialias: !0, depth: !1, failIfMajorPerformanceCaveat: !0, preserveDrawingBuffer: !1, stencil: !0});
    ...
    function Hn(a, c, d, e) {
        var f = a.f, g = c.gb();
        if (Lf(a.a, g))
            a = a.a.get(g), f.bindTexture(3553, a.ob), 9729 != a.Rg && (f.texParameteri(3553, 10240, 9729), a.Rg = 9729), 9729 != a.Tg && (f.texParameteri(3553, 10240, 9729), a.Tg = 9729);
        else {
    ...
    l.Cj = function (a, c) {
        for (var d = this.f, e; 1024 < this.a.rc() - this.l; ) {
            if (e = this.a.b.kc)
                d.deleteTexture(e.ob);
            else if (+this.a.b.Yb == c.index)
                break;
            else
                --this.l;
            this.a.pop()
    ...
    l.xe = function (a) {
        ...
        if (d.isContextLost())
            return!1;
        if (!a)
            return this.j && (Cf(this.b, !1), this.j = !1), !1;
        this.v = a.focus;
        ...
        h = 0;
        for (k = f.length; h < k; ++h)
            n = f[h], ei(n, g) && "ready" == n.R && (m = Bi(this, n.layer), m.wf(a, n, c) && e.push(n));
        ...
        h = 0;
        for (k = e.length; h < k; ++h)
            n = e[h], m = Bi(this, n.layer), m.qh(a, n, c);
    ...
    l.oa = function (a, c, d, e, f, g) {
        ...
        for (n = m.length - 1; 0 <= n; --n) {
            h = m[n];
            var p = h.layer;
            if (ei(h, k.resolution) && f.call(g, p) && (h = Bi(this, p).oa(a, c, d, e)))
                return h
        }
    };
    l.nh = function (a, c, d, e) {
        ...
        for (k = h.length - 1; 0 <= k; --k) {
            var m = h[k], n = m.layer;
            if (ei(m, g.resolution) && d.call(e, n) && (f = Bi(this, n).ge(a, c)))
                return!0
        }
        return f
    };
    l.mh = function (a, c, d, e, f) {
        ...
        for (m = k.length - 1; 0 <= m; --m) {
            h = k[m];
            var n = h.layer;
            if (ei(h, g.resolution) && f.call(e, n) && (h = Bi(this, n).xc(a, c, d, e)))
                return h
        }
    };
    ...
    l.ed = function (a, c, d, e, f) {
        if (this.f)
            return a = this.Ma(a), this.M.oa(a, this.f, c, void 0 !== d ? d : null, void 0 !== e ? e : Ac, void 0 !== f ? f : null)
    };
    l.Pl = function (a, c, d, e, f) {
        if (this.f)
            return this.M.mh(a, this.f, c, void 0 !== d ? d : null, void 0 !== e ? e : Ac, void 0 !== f ? f : null)
    };
    l.gl = function (a, c, d) {
        if (!this.f)
            return!1;
    ...
    l.Oo = function (a) {
        ...
        if (void 0 !== f && 0 < f[0] && 0 < f[1] && g && ge(g)) {
            ...
            for (d = m.length; c < d; ++c)
                n[w(m[c].layer)] = m[c];
            e = g.V();
            k = {animate: !1, attributions: {}, coordinateToPixelMatrix: this.Ra, extent: h, focus: this.T ? this.T : e.center, index: this.pb++, layerStates: n, layerStatesArray: m, logos: Pa({}, this.Je), pixelRatio: this.Ke, pixelToCoordinateMatrix: this.Le, postRenderFunctions: [], size: f, skippedFeatureUids: this.ze,
                tileQueue: this.na, time: a, usedTiles: {}, viewState: e, viewHints: k, wantedTiles: {}}
        }
        if (k) {
            a = this.R;
            c = f = 0;
    ...
    l.Sc = function () {
        ...
        if (a) {
            ...
            if (e && "auto" != d.width && "auto" != d.height && !d.boxSizing)
                c = Df(a, d.width, "width", "pixelWidth"), a = Df(a, d.height, "height", "pixelHeight"), a = new hf(c, a);
            else {
                d = new hf(a.offsetWidth, a.offsetHeight);
                c = Ff(a, "padding");
                if (!Se || 9 <= Number(ef))
                    e = yf(a, "borderLeftWidth"), f = yf(a, "borderRightWidth"), g = yf(a, "borderTopWidth"), a = yf(a, "borderBottomWidth"), a = new xf(parseFloat(g), parseFloat(f), parseFloat(a), parseFloat(e));
                else {
                    e = Hf(a,
                            "borderLeft");
    ...
    function Pn(a) {
        ...
        if (void 0 !== c && c.f && void 0 !== d) {
            ...
            if ("bottom-right" == g || "center-right" == g || "top-right" == g)
                "" !== a.a.$d && (a.a.$d = c.left = ""), h = Math.round(e[0] - d[0] - h) + "px", a.a.ye != h && (a.a.ye = c.right = h);
            else {
            ...
            if ("bottom-left" == g || "bottom-center" == g || "bottom-right" ==
                    g)
                "" !== a.a.Be && (a.a.Be = c.top = ""), d = Math.round(e[1] - d[1] - f) + "px", a.a.Hd != d && (a.a.Hd = c.bottom = d);
            else {
    ...
    function Vn(a) {
        ...
        if (c.f && d.f) {
            ...
            if (a = a.a.aa().bb())
                k = [g[0] - a[0], g[1] - a[1]], Rb(k, d), Mb(k, a);
            c.qf(k);
    ...
    function ao(a) {
        ...
        var c = void 0 !== a.className ? a.className : "ol-zoomslider", d = pf("BUTTON", {type: "button", "class": c + "-thumb ol-unselectable"}), c = pf("DIV", [c, "ol-unselectable", "ol-control"], d);
        this.o = new Gh(c);
    ...
    function go(a) {
        ...
        var c = void 0 !== a.className ? a.className : "ol-zoom-extent", d = pf("BUTTON", {type: "button", title: void 0 !== a.tipLabel ? a.tipLabel : "Fit to extent"}, void 0 !== a.label ? a.label : "E");
    ...
    function jo(a, c, d) {
        var e;
        d && (e = {dataProjection: d.dataProjection ? d.dataProjection : a.Oa(c), featureProjection: d.featureProjection});
        return ko(a, e)
    }
    function ko(a, c) {
        var d;
    ...
    function oo(a, c, d, e, f, g) {
        ...
        if (0 !== m)
            if (1 == m)
                ...
                n = h.length;
                for (p = !1; m < n; )
                    f = m + (n - m >> 1), k = +tb(h[f], d), 0 > k ? m = f + 1 : (n = f, p = !k);
                f = p ? m : ~m;
    ...
    function qo(a, c, d, e, f, g) {
        var h = 0;
        if (g)
            return po(a, h, c[c.length - 1], d, e, f);
        if (e < a[d - 1])
    ...
    l.vj = function (a) {
        if (this.A) {
            ...
            this.A = a.ga().slice(), a = a.zb().slice(), this.i.push();
        this.i.push(a);
        this.u()
    };
    l.clone = function () {
        for (var a = new to(null), c = this.i.length, d = Array(c), e = 0; e < c; ++e)
            d[e] = this.i[e].slice();
    ...
    l.rb = function (a, c, d, e) {
        ...
        if (this.R != this.g) {
            ...
            for (m = f.length; k < m; ++k)
                var n = f[k], h = Ad(this.A, g, n, this.a, h), g = n[n.length - 1];
            this.S = Math.sqrt(h);
            this.R = this.g
        }
        f = zk(this);
    ...
    l.jm = function () {
        ...
        f = 0;
        for (g = c.length; f < g; ++f)
            var h = c[f], e = e + xd(a, d, h, this.a), d = h[h.length - 1];
        return e
    };
    l.Z = function (a) {
        var c;
    ...
    function Ak(a) {
        if (a.M != a.g) {
            ...
            for (m = d.length; k < m; ++k)
                n = d[k], h = Pd(c, f, n, e, g, 2 * k, h), f = n[n.length - 1];
            a.N = h;
            a.M = a.g
        }
        return a.N
    ...
    l.hd = function (a) {
        ...
        if (f)
            return a = new Do(null), Go(a), a.c = d, Eo(a), a.u(), this.l[c] = a;
        this.o = a;
        return this
    };
    l.X = function () {
    ...
    function Po(a) {
        ...
        this.schemaLocation = "";
        this.b = {};
        this.b["http://www.opengis.net/gml"] = {featureMember: Ll(Po.prototype.qd), featureMembers: Ll(Po.prototype.qd)};
        Mo.call(this)
    }
    y(Po, Mo);
    var Qo = /^[\s\xa0]*$/;
    ...
    l.qd = function (a, c) {
        ...
        if ("FeatureCollection" == d)
            ...
            for (v in h) {
                ...
                k = 0;
                for (m = g.length; k < m; ++k)
                    (-1 === g[k].indexOf(":") ? "p0" : g[k].split(":")[0]) === v && (p[g[k].split(":").pop()] = "featureMembers" == d ? Kl(this.Ef, this) : Ll(this.Ef, this));
                f[h[v]] = p
            }
    ...
    l.Oi = {"http://www.opengis.net/gml": {lineStringMember: Kl(Po.prototype.Pg), lineStringMembers: Kl(Po.prototype.Pg)}};
    ...
    l.Yf = {"http://www.opengis.net/gml": {Point: Ll(Po.prototype.Sh), MultiPoint: Ll(Po.prototype.Qh), LineString: Ll(Po.prototype.ue), MultiLineString: Ll(Po.prototype.Ph), LinearRing: Ll(Po.prototype.Oh), Polygon: Ll(Po.prototype.ve), MultiPolygon: Ll(Po.prototype.Rh), Box: Ll(bp.prototype.qo)}};
    function cp(a) {
        a = a ? a : {};
        Po.call(this, a);
    ...
    l.uo = function (a, c) {
        for (var d = El(a, !1), e = /^\s*([+\-]?\d*\.?\d+(?:[eE][+\-]?\d+)?)\s*/, f = [], g; g = e.exec(d); )
    ...
    l.He = function (a, c, d) {
        ...
        "Polygon" === a.nodeName || "PolygonPatch" === a.nodeName ? (c = c.Pd(), Tl({node: a, srsName: e}, fp, this.Wi, c, d, void 0, this)) : "Surface" === a.nodeName && (e = Dl(a.namespaceURI, "patches"), a.appendChild(e), a = Dl(e.namespaceURI, "PolygonPatch"), e.appendChild(a), this.He(a, c, d))
    };
    l.Ce = function (a, c, d) {
        var e = d[d.length - 1].srsName;
    ...
    var gp = {"http://www.opengis.net/gml": {surfaceMember: M(cp.prototype.Gi), polygonMember: M(cp.prototype.Gi)}}, hp = {"http://www.opengis.net/gml": {pointMember: M(cp.prototype.tp)}}, ip = {"http://www.opengis.net/gml": {lineStringMember: M(cp.prototype.Ai), curveMember: M(cp.prototype.Ai)}}, fp = {"http://www.opengis.net/gml": {exterior: M(cp.prototype.Fi), interior: M(cp.prototype.Fi)}}, jp = {"http://www.opengis.net/gml": {Curve: M(cp.prototype.Ce), MultiCurve: M(cp.prototype.Ci), Point: M(cp.prototype.Ei), MultiPoint: M(cp.prototype.sp),
            LineString: M(cp.prototype.Ce), MultiLineString: M(cp.prototype.Ci), LinearRing: M(cp.prototype.Bi), Polygon: M(cp.prototype.He), MultiPolygon: M(cp.prototype.Di), Surface: M(cp.prototype.He), MultiSurface: M(cp.prototype.Di), Envelope: M(cp.prototype.rp)}}, kp = {MultiLineString: "lineStringMember", MultiCurve: "curveMember", MultiPolygon: "polygonMember", MultiSurface: "surfaceMember"};
    ...
    cp.prototype.s = function (a, c) {
        c = ko(this, c);
        var d = Dl("http://www.opengis.net/gml", "geom"), e = {node: d, srsName: this.srsName, curve: this.i, surface: this.j, multiSurface: this.o, multiCurve: this.l};
        c && Pa(e, c);
        this.Fe(d, a, [e]);
        return d
    };
    cp.prototype.a = function (a, c) {
        ...
        var e = {srsName: this.srsName, curve: this.i, surface: this.j, multiSurface: this.o, multiCurve: this.l, featureNS: this.featureNS, featureType: this.featureType};
        c && Pa(e, c);
    ...
    var xp = {rte: rp, trk: tp, wpt: vp}, yp = N(mp, {rte: Kl(rp), trk: Kl(tp), wpt: Kl(vp)}), pp = N(mp, {text: K(V, "linkText"), type: K(V, "linkType")}), sp = N(mp, {name: K(V), cmt: K(V), desc: K(V), src: K(V), link: op, number: K(Wo), extensions: qp, type: K(V), rtept: function (a, c) {
            var d = P({}, zp, a, c);
            d && np(c[c.length - 1].flatCoordinates, a, d)
        }}), zp = N(mp, {ele: K(Uo), time: K(To)}), up = N(mp, {name: K(V), cmt: K(V), desc: K(V), src: K(V), link: op, number: K(Wo), type: K(V), extensions: qp, trkseg: function (a, c) {
            var d = c[c.length - 1];
            Sl(Ap, a, c);
            d.ends.push(d.flatCoordinates.length)
        }}),
            Ap = N(mp, {trkpt: function (a, c) {
                    var d = P({}, Bp, a, c);
                    d && np(c[c.length - 1].flatCoordinates, a, d)
                }}), Bp = N(mp, {ele: K(Uo), time: K(To)}), wp = N(mp, {ele: K(Uo), time: K(To), magvar: K(Uo), geoidheight: K(Uo), name: K(V), cmt: K(V), desc: K(V), src: K(V), link: op, sym: K(V), type: K(V), fix: K(V), sat: K(Wo), hdop: K(Uo), vdop: K(Uo), pdop: K(Uo), ageofdgpsdata: K(Uo), dgpsid: K(Wo), extensions: qp});
    function Cp(a, c) {
        c || (c = []);
    ...
    var Fp = ["text", "type"], Ep = N(mp, {text: M(Zo), type: M(Zo)}), Jp = N(mp, "name cmt desc src link number type rtept".split(" ")), Kp = N(mp, {name: M(Zo), cmt: M(Zo), desc: M(Zo), src: M(Zo), link: M(Dp), number: M(ap), type: M(Zo), rtept: Nl(M(Gp))}), Lp = N(mp, "name cmt desc src link number type trkseg".split(" ")), Op = N(mp, {name: M(Zo), cmt: M(Zo), desc: M(Zo), src: M(Zo), link: M(Dp), number: M(ap), type: M(Zo), trkseg: Nl(M(function (a, c, d) {
            ...
            Hp = N(mp, "ele time magvar geoidheight name cmt desc src link sym type fix sat hdop vdop pdop ageofdgpsdata dgpsid".split(" ")), Ip = N(mp, {ele: M($o), time: M(function (a, c) {
        ...
        }), magvar: M($o), geoidheight: M($o), name: M(Zo), cmt: M(Zo), desc: M(Zo), src: M(Zo), link: M(Dp), sym: M(Zo), type: M(Zo), fix: M(Zo), sat: M(ap), hdop: M($o),
        vdop: M($o), pdop: M($o), ageofdgpsdata: M($o), dgpsid: M(ap)}), Pp = {Point: "wpt", LineString: "rte", MultiLineString: "trk"};
    function Qp(a, c) {
        var d = a.W();
        if (d && (d = Pp[d.X()]))
            return Dl(c[c.length - 1].node.namespaceURI, d)
    }
    var Rp = N(mp, {rte: M(function (a, c, d) {
            var e = d[0], f = c.L();
            a = {node: a, properties: f};
            if (c = c.W())
                c = lo(c, !0, e), a.geometryLayout = c.f, f.rtept = c.Z();
            ...
            f.properties = c.L();
            if (c = c.W())
                c = lo(c, !0, e), f.geometryLayout = c.f, Gp(a, c.Z(),
                        d)
        })});
    ...
    function $p(a) {
        ...
        if (a.g != a.b.length) {
            for (var f = {}, d = c = 0; c < a.b.length; )
                e = a.b[c], aq(f, e) || (a.b[d++] = e, f[e] = 1), c++;
            a.b.length = d
        }
    }
    l.get = function (a, c) {
    ...
    gq.prototype.toString = function () {
        ...
        var d = this.a;
        if (d || "file" == c)
            a.push("//"), (c = this.l) && a.push(mq(c, nq, !0), "@"), a.push(encodeURIComponent(String(d)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), d = this.o, null != d && a.push(":", String(d));
        if (d = this.b)
            this.a && "/" != d.charAt(0) && a.push("/"), a.push(mq(d, "/" == d.charAt(0) ? oq : pq, !0));
    ...
    l.uc = function (a) {
        ...
        var c = [];
        if (ea(a))
            yq(this, a) && (c = ze(c, this.b.get(xq(this, a))));
        else {
            a = this.b.uc();
    ...
    var Cq = ["http://www.google.com/kml/ext/2.2"], Dq = [null, "http://earth.google.com/kml/2.0", "http://earth.google.com/kml/2.1", "http://earth.google.com/kml/2.2", "http://www.opengis.net/kml/2.2"], Eq = [255, 255, 255, 1], Fq = new ak({color: Eq}), Gq = [20, 2], Hq = [64, 64], Iq = new ui({anchor: Gq, anchorOrigin: "bottom-left", anchorXUnits: "pixels", anchorYUnits: "pixels", crossOrigin: "anonymous", rotation: 0, scale: .5, size: Hq, src: "https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png"}), Jq = new gk({color: Eq, width: 1}), Kq = new zq({font: "bold 16px Helvetica",
        fill: Fq, stroke: new gk({color: [51, 51, 51, 1], width: 2}), scale: .8}), Bq = [new jk({fill: Fq, image: Iq, text: Kq, stroke: Jq, zIndex: 0})], Lq = {fraction: "fraction", pixels: "pixels"};
    function Mq(a, c) {
        var d = null, e = [0, 0], f = "start";
        a.a && (d = a.a.fd()) && 2 == d.length && (e[0] = a.a.i * d[0] / 2, e[1] = -a.a.i * d[1] / 2, f = "left");
        if (Sa(a.Ea()))
            d = new zq({text: c, offsetX: e[0], offsetY: e[1], textAlign: f});
        else {
            var d = a.Ea(), g = {}, h;
            for (h in d)
                g[h] = d[h];
    ...
    function Nq(a, c, d, e, f) {
        return function () {
            ...
            if (a)
                return g ? (g = Mq(a[0], h), a.concat(g)) : a;
            if (c) {
                var k = Oq(c, d, e);
    ...
    var kr = N(Dq, {value: Ll(V)}), jr = N(Dq, {Data: function (a, c) {
            ...
            Sl(lr, a, c)
        }}), Yq = N(Dq, {extrude: K(Ro), altitudeMode: K(V)}), Uq = N(Dq, {coordinates: Ll(Qq)}), fr = N(Dq, {innerBoundaryIs: function (a, c) {
            var d = P(void 0, mr, a, c);
            d && c[c.length - 1].push(d)
        }, outerBoundaryIs: function (a, c) {
            var d = P(void 0, nr, a, c);
            d && (c[c.length - 1][0] = d)
        }}), Wq = N(Dq, {when: function (a, c) {
        ...
        }})), Zq = N(Dq, {coordinates: Ll(Qq)}), or = N(Dq, {href: K(Rq)}, N(Cq, {x: K(Uo), y: K(Uo), w: K(Uo), h: K(Uo)})), pr = N(Dq, {Icon: K(function (a, c) {
            var d = P({}, or, a, c);
            return d ? d : null
        ...
        }), scale: K(Sq)}), mr = N(Dq, {LinearRing: Ll(Tq)}), qr = N(Dq, {color: K(Pq), scale: K(Sq)}), rr = N(Dq, {color: K(Pq),
        width: K(Uo)}), br = N(Dq, {LineString: Kl(Xq), LinearRing: Kl($q), MultiGeometry: Kl(ar), Point: Kl(dr), Polygon: Kl(er)}), sr = N(Cq, {Track: Kl(Vq)}), ur = N(Dq, {ExtendedData: ir, Link: function (a, c) {
            Sl(tr, a, c)
        }, address: K(V), description: K(V), name: K(V), open: K(Ro), phoneNumber: K(V), visibility: K(Ro)}), tr = N(Dq, {href: K(Rq)}), nr = N(Dq, {LinearRing: Ll(Tq)}), vr = N(Dq, {Style: K(gr), key: K(V), styleUrl: K(function (a) {
            var c = El(a, !1).trim();
            return a.baseURI ? uq(a.baseURI, c).toString() : c
        })}), xr = N(Dq, {ExtendedData: ir, MultiGeometry: K(ar, "geometry"),
        LineString: K(Xq, "geometry"), LinearRing: K($q, "geometry"), Point: K(dr, "geometry"), Polygon: K(er, "geometry"), Style: K(gr), StyleMap: function (a, c) {
            var d = P(void 0, wr, a, c);
            if (d) {
                var e = c[c.length - 1];
                Array.isArray(d) ? e.Style = d : "string" === typeof d && (e.styleUrl = d)
            }
        }, address: K(V), description: K(V), name: K(V), open: K(Ro), phoneNumber: K(V), styleUrl: K(Rq), visibility: K(Ro)}, N(Cq, {MultiTrack: K(function (a, c) {
            var d = P([], sr, a, c);
            if (d) {
                var e = new U(null);
                ro(e, d);
        ...
        }, "geometry"), Track: K(Vq, "geometry")})), yr = N(Dq, {color: K(Pq),
        fill: K(Ro), outline: K(Ro)}), lr = N(Dq, {SimpleData: function (a, c) {
            var d = a.getAttribute("name");
            if (null !== d) {
                var e = V(a);
                c[c.length - 1][d] = e
            }
        }}), hr = N(Dq, {IconStyle: function (a, c) {
            var d = P({}, pr, a, c);
            if (d) {
                ...
                h = new ui({anchor: h, anchorOrigin: "bottom-left", anchorXUnits: k, anchorYUnits: m, crossOrigin: "anonymous", offset: p, offsetOrigin: "bottom-left", rotation: u, scale: d, size: r, src: g});
                e.imageStyle = h
            }
        }, LabelStyle: function (a, c) {
            var d = P({}, qr, a,
                    c);
            d && (c[c.length - 1].textStyle = new zq({fill: new ak({color: "color"in d ? d.color : Eq}), scale: d.scale}))
        }, LineStyle: function (a, c) {
            var d = P({}, rr, a, c);
            d && (c[c.length - 1].strokeStyle = new gk({color: "color"in d ? d.color : Eq, width: "width"in d ? d.width : 1}))
    ...
    l = Aq.prototype;
    l.Cf = function (a, c) {
        var d = N(Dq, {Document: Jl(this.Cf, this), Folder: Jl(this.Cf, this), Placemark: Kl(this.Kf, this), Style: this.Fo.bind(this), StyleMap: this.Eo.bind(this)});
        if (d = P([], d, a, c, this))
            return d
    };
    l.Kf = function (a, c) {
    ...
    l.gc = function (a, c) {
        ...
        if ("Document" == d || "Folder" == d)
            return(d = this.Cf(a, [jo(this, a, c)])) ? d : [];
        if ("Placemark" == d)
            return(d = this.Kf(a, [jo(this, a, c)])) ? [d] : [];
        if ("kml" == d) {
            d = [];
            var e;
    ...
    function Ar(a, c) {
        ...
        for (d = c.firstElementChild; d; d = d.nextElementSibling)
            if (ub(Dq, d.namespaceURI) && "name" == d.localName)
                return V(d);
        for (d = c.firstElementChild; d; d = d.nextElementSibling) {
            var e = d.localName;
            if (ub(Dq, d.namespaceURI) && ("Document" == e || "Folder" == e || "Placemark" == e || "kml" == e) && (e = Ar(a, d)))
                return e
        }
    }
    l.Ao = function (a) {
    ...
    function Cr(a, c) {
        ...
        for (d = c.firstElementChild; d; d = d.nextElementSibling)
            f = d.localName, !ub(Dq, d.namespaceURI) || "Document" != f && "Folder" != f && "kml" != f || xb(e, Cr(a, d));
        return e
    }
    function Dr(a, c) {
    ...
    var Yr = N(Dq, ["Document", "Placemark"]), as = N(Dq, {Document: M(function (a, c, d) {
        ...
        }), scale: M(Xr)}), hs = N(Dq, ["color", "scale"]), is = N(Dq, {color: M(Dr), scale: M(Xr)}), js = N(Dq, ["color", "width"]), ks = N(Dq, {color: M(Dr), width: M($o)}), Lr = N(Dq, {LinearRing: M(Qr)}), Jr = N(Dq, {LineString: M(Qr),
        Point: M(Qr), Polygon: M(Tr), GeometryCollection: M(Er)}), Or = N(Dq, "name open visibility address phoneNumber description styleUrl Style".split(" ")), Pr = N(Dq, {MultiGeometry: M(Er), LineString: M(Qr), LinearRing: M(Qr), Point: M(Qr), Polygon: M(Tr), Style: M(function (a, c, d) {
            a = {node: a};
            ...
            e = Rl(e, c);
            Tl(a, ms, Ql, e, d, c)
        }), address: M(Zo), description: M(Zo), name: M(Zo),
        open: M(Yo), phoneNumber: M(Zo), styleUrl: M(Zo), visibility: M(Yo)}), Rr = N(Dq, {coordinates: M(function (a, c, d) {
            d = d[d.length - 1];
            var e = d.layout;
            d = d.stride;
            var f;
            ...
            Zo(a, k)
        })}), Ur = N(Dq, {outerBoundaryIs: M(Kr), innerBoundaryIs: M(Kr)}), ns = N(Dq, {color: M(Dr)}), ls = N(Dq, ["IconStyle", "LabelStyle", "LineStyle", "PolyStyle"]), ms = N(Dq, {IconStyle: M(function (a,
                c, d) {
            a = {node: a};
    ...
    function Fr(a, c) {
        if (a)
            return Dl(c[c.length - 1].node.namespaceURI, bs[a.X()])
    }
                ...
                return k
                        ...
                        g.prototype.Qg = function () {
                            ...
                            for (var c = a.Aa() + a.ca, e = 1, f = 0, g = 0, h = 0, v = [], x; a.ca < c; )
                                if (f || (f = a.Aa(), e = f & 7, f = f >> 3), f--, 1 === e || 2 === e)
                                    g += a.sd(), h += a.sd(), 1 === e && (x && v.push(x), x = []), x.push(new k(g, h));
                                else if (7 === e)
                                    x && x.push(x[0].clone());
                                else
                        ...
                        g.prototype.bbox = function () {
                            ...
                            for (var c = a.Aa() + a.ca, e = 1, f = 0, g = 0, h = 0, k = Infinity, x = -Infinity, z = Infinity, E = -Infinity; a.ca <
                                    c; )
                                if (f || (f = a.Aa(), e = f & 7, f = f >> 3), f--, 1 === e || 2 === e)
                                    g += a.sd(), h += a.sd(), g < k && (k = g), g > x && (x = g), h < z && (z = h), h > E && (E = h);
                                else if (7 !== e)
                                    throw Error("unknown command " + e);
                            return[k, z, x, E]
                        }
                        ...
                        function k(a) {
                            for (var c = null, e = a.Aa() + a.ca; a.ca < e; )
                                c = a.Aa() >> 3, c = 1 === c ? a.Mf() : 2 === c ? a.vo() : 3 === c ? a.ro() : 4 === c ? a.Go() : 5 === c ? a.Aa() : 6 === c ? a.sd() : 7 === c ? a.po() : null;
                            return c
                        }
                        var m = a("./vectortilefeature.js");
                        c.ha = g;
                        g.prototype.feature = function (a) {
                            if (0 > a || a >= this.Cd.length)
    ...
    var Ns = [null], Os = N(Ns, {nd: function (a, c) {
            c[c.length - 1].Mc.push(a.getAttribute("ref"))
        }, tag: Ms}), Qs = N(Ns, {node: function (a, c) {
            ...
            for (var d = c[0], e = a.getAttribute("id"), f = P({Mc: [], xd: {}}, Os, a, c), g = c[c.length - 1], h = [], k = 0, m = f.Mc.length; k < m; k++)
                xb(h, g.Ug[f.Mc[k]]);
    ...
    var Vs = [null, "http://www.opengis.net/ows/1.1"], Us = N(Vs, {ServiceIdentification: K(function (a, c) {
            return P({}, Ws, a, c)
        }), ServiceProvider: K(function (a, c) {
            return P({}, Xs, a, c)
        }), OperationsMetadata: K(function (a, c) {
            return P({}, Ys, a, c)
        })}), Zs = N(Vs, {DeliveryPoint: K(V), City: K(V), AdministrativeArea: K(V), PostalCode: K(V), Country: K(V), ElectronicMailAddress: K(V)}), $s = N(Vs, {Value: Ml(function (a) {
            return V(a)
        })}), at = N(Vs, {AllowedValues: K(function (a, c) {
            return P({}, $s, a, c)
        })}), ct = N(Vs, {Phone: K(function (a, c) {
            return P({},
                    bt, a, c)
        }), Address: K(function (a, c) {
            return P({}, Zs, a, c)
        })}), et = N(Vs, {HTTP: K(function (a, c) {
            return P({}, dt, a, c)
        })}), dt = N(Vs, {Get: Ml(function (a, c) {
            var d = Rs(a);
            return d ? P({href: d}, ft, a, c) : void 0
        }), Post: void 0}), gt = N(Vs, {DCP: K(function (a, c) {
            return P({}, et, a, c)
        })}), Ys = N(Vs, {Operation: function (a, c) {
            var d = a.getAttribute("name"), e = P({}, gt, a, c);
            e && (c[c.length - 1][d] = e)
        }}), bt = N(Vs, {Voice: K(V), Facsimile: K(V)}), ft = N(Vs, {Constraint: Ml(function (a, c) {
            var d = a.getAttribute("name");
            return d ? P({name: d}, at, a, c) : void 0
        })}),
            ht = N(Vs, {IndividualName: K(V), PositionName: K(V), ContactInfo: K(function (a, c) {
                    return P({}, ct, a, c)
                })}), Ws = N(Vs, {Title: K(V), ServiceTypeVersion: K(V), ServiceType: K(V)}), Xs = N(Vs, {ProviderName: K(V), ProviderSite: K(Rs), ServiceContact: K(function (a, c) {
            return P({}, ht, a, c)
        })});
    function it(a, c, d, e) {
        var f;
    ...
    ot.prototype.Ff = function (a, c) {
        if ("Topology" == a.type) {
            ...
            if (d) {
                ...
                k = 0;
                for (m = g.length; k < m; ++k)
                    for (var n = g[k], p = d, q = h, r = 0, u = 0, v = void 0, x = void 0, z = void 0, x = 0, z = n.length; x < z; ++x)
                        v = n[x], r += v[0], u += v[1], v[0] = r, v[1] = u, ut(v, p, q)
            }
            d = [];
            h = Ra(a.objects);
            k = 0;
            for (m = h.length; k < m; ++k)
                "GeometryCollection" === h[k].type ? (n = h[k], d.push.apply(d, rt(n, g, e, f, c))) : (n = h[k], d.push(st(n, g, e, f, c)));
            return d
        }
        return[]
    };
    ...
    var Bt = {"http://www.opengis.net/wfs": {totalInserted: K(Wo), totalUpdated: K(Wo), totalDeleted: K(Wo)}}, Ct = {"http://www.opengis.net/ogc": {FeatureId: Kl(function (a) {
                return a.getAttribute("fid")
            })}}, Dt = {"http://www.opengis.net/wfs": {Feature: function (a, c) {
                Sl(Ct, a, c)
            }}}, xt = {"http://www.opengis.net/wfs": {TransactionSummary: K(function (a, c) {
                return P({}, Bt, a, c)
    ...
    var Gt = {"http://www.opengis.net/wfs": {Insert: M(function (a, c, d) {
                ...
                if (void 0 !== f) {
                    ...
                    Tl({node: a,
                        srsName: e.srsName}, Gt, Ol("Property"), h, d);
                    Ft(a, f)
                }
                ...
                a.appendChild(e);
                Zo(e, c.name);
                void 0 !== c.value && null !== c.value && (e = Dl("http://www.opengis.net/wfs", "Value"), a.appendChild(e), c.value instanceof
                        dd ? cp.prototype.Fe(e, c.value, d) : Zo(e, c.value))
    ...
    var It = {"http://www.opengis.net/wfs": {Query: M(function (a, c, d) {
                ...
                if (e = e.filter)
                    h = Dl("http://www.opengis.net/ogc", "Filter"), a.appendChild(h), Tl({node: h}, It, Ol(e.Ae), [e], d)
            })}, "http://www.opengis.net/ogc": {And: M(Ht), Or: M(Ht), Not: M(function (a,
                    c, d) {
                c = c.condition;
            ...
            }), PropertyIsEqualTo: M(Jt), PropertyIsNotEqualTo: M(Jt), PropertyIsLessThan: M(Jt), PropertyIsLessThanOrEqualTo: M(Jt), PropertyIsGreaterThan: M(Jt), PropertyIsGreaterThanOrEqualTo: M(Jt), PropertyIsNull: M(function (a, c) {
                Kt(a, c.a)
    ...
    vt.prototype.j = function (a) {
        ...
        e = a.featureTypes;
        a = [{node: c, srsName: a.srsName, featureNS: a.featureNS ? a.featureNS : this.g, featurePrefix: a.featurePrefix, geometryName: a.geometryName, filter: d, propertyNames: a.propertyNames ? a.propertyNames : []}];
        d = Pa({}, a[a.length - 1]);
        d.node = c;
    ...
    vt.prototype.U = function (a, c, d, e) {
        ...
        a && (k = {node: g, featureNS: e.featureNS, featureType: e.featureType, featurePrefix: e.featurePrefix}, Pa(k, h), Tl(k, Gt, Ol("Insert"), a, f));
        c && (k = {node: g, featureNS: e.featureNS, featureType: e.featureType,
            featurePrefix: e.featurePrefix}, Pa(k, h), Tl(k, Gt, Ol("Update"), c, f));
        d && Tl({node: g, featureNS: e.featureNS, featureType: e.featureType, featurePrefix: e.featurePrefix}, Gt, Ol("Delete"), d, f);
        e.nativeElements && Tl({node: g, featureNS: e.featureNS, featureType: e.featureType, featurePrefix: e.featurePrefix}, Gt, Ol("Native"), e.nativeElements, f);
        return g
    };
    ...
    var Rt = {Point: Nt, LineString: Ot, Polygon: Pt, MultiPoint: function (a) {
            var c = [];
            a = a.ee();
            for (var d = 0, e = a.length; d < e; ++d)
                c.push("(" + Nt(a[d]) + ")");
    ...
    l.bo = function () {
        if (this.match(2)) {
            for (var a = [this.Bf()]; this.match(5); )
                a.push(this.Bf());
            if (this.match(3))
                return a
        } else if (Wt(this))
    ...
    function au(a) {
        for (var c = [$t(a)]; a.match(5); )
            c.push($t(a));
        return c
    }
    function bu(a) {
        for (var c = [a.zf()]; a.match(5); )
            c.push(a.zf());
        return c
    }
    function Wt(a) {
    ...
    var Zt = {POINT: D, LINESTRING: T, POLYGON: F, MULTIPOINT: so, MULTILINESTRING: U, MULTIPOLYGON: to}, Yt = {POINT: St.prototype.Af, LINESTRING: St.prototype.zf, POLYGON: St.prototype.Bf, MULTIPOINT: St.prototype.ao, MULTILINESTRING: St.prototype.$n, MULTIPOLYGON: St.prototype.bo};
    function cu() {
        this.version = void 0
    }
    y(cu, Ss);
    ...
    var lu = [null, "http://www.opengis.net/wms"], du = N(lu, {Service: K(function (a, c) {
        ...
        EX_GeographicBoundingBox: K(function (a, c) {
            ...
            return{name: a.getAttribute("name"),
                units: a.getAttribute("units"), unitSymbol: a.getAttribute("unitSymbol"), "default": a.getAttribute("default"), multipleValues: So(a.getAttribute("multipleValues")), nearestValue: So(a.getAttribute("nearestValue")), current: So(a.getAttribute("current")), values: V(a)}
        ...
        })}), vu = N(lu, {Title: K(V), OnlineResource: K(Rs), LogoURL: K(iu)}), uu = N(lu, {westBoundLongitude: K(Uo),
        eastBoundLongitude: K(Uo), southBoundLatitude: K(Uo), northBoundLatitude: K(Uo)}), ou = N(lu, {GetCapabilities: K(gu), GetMap: K(gu), GetFeatureInfo: K(gu)}), hu = N(lu, {Format: Ml(V), DCPType: Ml(function (a, c) {
            return P({}, xu, a, c)
        })}), xu = N(lu, {HTTP: K(function (a, c) {
            return P({}, yu, a, c)
        })}), yu = N(lu, {Get: K(eu), Post: K(eu)}), wu = N(lu, {Name: K(V), Title: K(V), Abstract: K(V), LegendURL: Ml(iu), StyleSheetURL: K(eu), StyleURL: K(eu)}), fu = N(lu, {Format: K(V), OnlineResource: K(Rs)}), ku = N(lu, {Keyword: Kl(V)});
    function zu(a) {
        a = a ? a : {};
    ...
    var Du = [null, "http://www.opengis.net/wmts/1.0"], Eu = [null, "http://www.opengis.net/ows/1.1"], Bu = N(Du, {Contents: K(function (a, c) {
            return P({}, Fu, a, c)
        })}), Fu = N(Du, {Layer: Ml(function (a, c) {
            return P({}, Gu, a, c)
        }), TileMatrixSet: Ml(function (a, c) {
            return P({}, Hu, a, c)
        })}), Gu = N(Du, {Style: Ml(function (a, c) {
            var d = P({}, Iu, a, c);
            if (d) {
        ...
        ResourceURL: Ml(function (a) {
            ...
            a && (e.resourceType = a);
            return e
        })}, N(Eu, {Title: K(V), Abstract: K(V), WGS84BoundingBox: K(function (a, c) {
            var d = P([], Lu, a, c);
            return 2 != d.length ? void 0 : Vb(d)
        }), Identifier: K(V)})), Iu = N(Du, {LegendURL: Ml(function (a) {
            var c = {};
            c.format = a.getAttribute("format");
            c.href = Rs(a);
            return c
        })}, N(Eu, {Title: K(V), Identifier: K(V)})), Ju = N(Du, {TileMatrixSet: K(V)}),
            Ku = N(Du, {Default: K(V), Value: Ml(V)}, N(Eu, {Identifier: K(V)})), Lu = N(Eu, {LowerCorner: Kl(Cu), UpperCorner: Kl(Cu)}), Hu = N(Du, {WellKnownScaleSet: K(V), TileMatrix: Ml(function (a, c) {
            return P({}, Mu, a, c)
        })}, N(Eu, {SupportedCRS: K(V), Identifier: K(V)})), Mu = N(Du, {TopLeftCorner: K(Cu), ScaleDenominator: K(Uo), TileWidth: K(Wo), TileHeight: K(Wo), MatrixWidth: K(Wo), MatrixHeight: K(Wo)}, N(Eu, {Identifier: K(V)}));
    function Nu(a) {
        pb.call(this);
        a = a || {};
        this.a = null;
    ...
    l.rb = function (a, c, d, e) {
        ...
        if (c < e) {
            if (0 === c)
                ...
                for (e = this.sf() / Math.sqrt(c), d[0] = f[0] + e * a, d[1] = f[1] + e * g, e = 2; e < this.a; ++e)
                    d[e] = f[e];
            d.length = this.a;
            return c
        }
    ...
    function Qu(a, c, d) {
        for (var e = [], f = a(0), g = a(1), h = c(f), k = c(g), m = [g, f], n = [k, h], p = [1, 0], q = {}, r = 1E5, u, v, x, z, E; 0 < --r && 0 < p.length; )
            x = p.pop(), f = m.pop(), h = n.pop(), g = x.toString(), g in q || (e.push(h[0], h[1]), q[g] = !0), z = p.pop(), g = m.pop(), k = n.pop(), E = (x + z) / 2, u = a(E), v = c(u), Fa(v[0], v[1], h[0], h[1], k[0], k[1]) < d ? (e.push(k[0], k[1]), g = z.toString(), q[g] = !0) : (p.push(z, E, E, x), n.push(k, v, v, h), m.push(g, u, u, f));
        return e
    }
    ...
    l.Mg = function (a) {
        ...
        if (-1 == h)
            ...
            for (k = 0; q != this.f && k++ < g; )
                q = Math.max(q - h, this.f), m = Wu(this, q, r, n, a, e, m);
            q = Da(f, this.f, this.g);
            for (k = 0; q != this.g && k++ < g; )
                q = Math.min(q + h, this.g), m = Wu(this, q, r, n, a, e, m);
            this.b.length = m;
            d = Math.floor(d / h) * h;
            f = Da(d, this.l, this.i);
            m = Xu(this, f, a, e, 0);
            for (k = 0; f != this.l && k++ < g; )
                f = Math.max(f - h, this.l), m = Xu(this, f, a, e, m);
            f = Da(d, this.l, this.i);
            for (k = 0; f != this.i && k++ < g; )
                f = Math.min(f + h, this.i), m = Xu(this, f, a, e, m);
            this.a.length = m
        }
        c.Ob(null, this.va);
        a = 0;
    ...
    function kv(a) {
        ...
        this.na = new H({source: new Q({useSpatialIndex: !1, wrapX: a.wrapX ? a.wrapX : !1}), style: a.style ? a.style : sv()});
    ...
    function uv(a, c) {
        if (a.s) {
            ...
            d = c.coordinate.slice(), a.R ? a.R.W().ma(d) : (a.R = new zl(new D(d)), yv(a));
        return!0
    }
    function xv(a, c) {
        var d = !1;
    ...
    function tv(a, c) {
        ...
        if (a.c === rv)
            a.s = d.slice(), g = a.a, g.push(d.slice()), f = g.length > a.xa, a.N(g, e);
        else if (a.c === pv) {
            g = a.a[0];
            g.push(d.slice());
            if (f = g.length > a.xa)
    ...
    function Bv(a) {
        ...
        this.s = this.ta = !1;
        this.j = [];
        this.S = new H({source: new Q({useSpatialIndex: !1, wrapX: !!a.wrapX}), style: a.style ? a.style : Gv(), updateWhileAnimating: !0, updateWhileInteracting: !0});
        this.wa = {Point: this.sm, LineString: this.fh, LinearRing: this.fh, Polygon: this.tm, MultiPoint: this.qm, MultiLineString: this.pm, MultiPolygon: this.rm, GeometryCollection: this.om};
        this.B = a.features;
    ...
    l.qm = function (a, c) {
        ...
        f = 0;
        for (g = d.length; f < g; ++f)
            e = d[f], e = {feature: a, geometry: c, depth: [f], index: f, la: [e, e]}, this.a.za(c.O(), e)
    };
    l.fh = function (a, c) {
        var d = c.Z(), e, f, g, h;
        e = 0;
        for (f = d.length - 1; e < f; ++e)
            g = d.slice(e, e + 2), h = {feature: a, geometry: c, index: e, la: g}, this.a.za(Vb(g), h)
    };
    l.pm = function (a, c) {
        ...
        for (k = d.length; h < k; ++h)
            for (e = d[h], f = 0, g = e.length - 1; f < g; ++f)
                m = e.slice(f, f + 2), n = {feature: a, geometry: c, depth: [h], index: f, la: m}, this.a.za(Vb(m), n)
    };
    l.tm = function (a, c) {
        var d = c.Z(), e, f, g, h, k, m, n;
        h = 0;
        ...
        for (n = d.length; m < n; ++m)
            for (p = d[m], h = 0, k = p.length; h < k; ++h)
                for (e = p[h], f = 0, g = e.length - 1; f < g; ++f)
                    q = e.slice(f, f + 2), r = {feature: a, geometry: c, depth: [h, m], index: f, la: q}, this.a.za(Vb(q), r)
    };
    l.om = function (a, c) {
        var d, e = c.c;
        for (d = 0; d < e.length; ++d)
            this.wa[e[d].X()].call(this, a, e[d])
    };
    function Lv(a, c) {
        var d = a.c;
    ...
    function Dv(a) {
        ...
        for (var c = 0, d = this.j.length; c < d; ++c) {
            for (var e = this.j[c], f = e[0], g = f.depth, h = f.geometry, k = h.Z(), m = f.la, e = e[1]; a.length < h.ua(); )
                a.push(0);
            switch (h.X()) {
                case "Point":
                    k = a;
    ...
    function Fv(a) {
        for (var c, d = this.j.length - 1; 0 <= d; --d)
            c = this.j[d][0], cm(this.a, Vb(c.la), c);
        ...
        if (0 < g.length) {
            ...
            if (Math.sqrt(Sb(c, m)) <= a.R) {
                ...
                for (m = g.length; c < m; ++c)
                    if (k = g[c].la, Qb(h[0], k[0]) && Qb(h[1], k[1]) || Qb(h[0], k[1]) && Qb(h[1], k[0]))
                        d[w(k)] = !0;
                    else
                        break;
                a.xa = d;
    ...
    l.jl = function (a, c) {
        for (var d = a.la, e = a.feature, f = a.geometry, g = a.depth, h = a.index, k; c.length < f.ua(); )
            c.push(0);
        switch (f.X()) {
            case "MultiLineString":
                k = f.Z();
    ...
    l.Wh = function () {
        ...
        if (this.Y && this.Y.type != Yh) {
            ...
            for (h = d.length - 1; 0 <= h; --h)
                g = d[h], n = g[0], p = w(n.feature), n.depth && (p += "-" + n.depth.join("-")), p in a || (a[p] = {}), 0 === g[1] ? (a[p].right = n, a[p].index = n.index) : 1 == g[1] && (a[p].left = n, a[p].index = n.index + 1);
            for (p in a) {
                m = a[p].right;
                h = a[p].left;
                g = a[p].index;
                ...
                q && (e = d, this.s = !0, e.ma(f), this.s = !1, f = [], void 0 !== h && (this.a.remove(h), f.push(h.la[0])), void 0 !== m && (this.a.remove(m), f.push(m.la[1])), void 0 !== h && void 0 !== m && (h = {depth: n.depth, feature: n.feature, geometry: n.geometry, index: k, la: f}, this.a.za(Vb(h.la), h)), Nv(this, d, g, n.depth,
    ...
    function Pv(a) {
        ...
        this.c = new H({source: new Q({useSpatialIndex: !1, features: c.features, wrapX: c.wrapX}), style: c.style ? c.style : Rv(), updateWhileAnimating: !0, updateWhileInteracting: !0});
        if (c.layers)
            if (ga(c.layers))
                a = function (a) {
                    return c.layers(a)
    ...
    function Qv(a) {
        ...
        if (f)
            Qa(this.a), g.ed(a.pixel, function (a, c) {
                if (this.o(a, c)) {
                    m.push(a);
                    var d = w(a);
                    this.a[d] = c;
            ...
            g.ed(a.pixel, function (a, f) {
                if (this.o(a, f)) {
                    if (!c && !e || ub(h.a, a))
                        (d || e) && ub(h.a, a) && (k.push(a), g = w(a), delete this.a[g]);
                    else {
                        m.push(a);
                        var g =
                                w(a);
    ...
    function Sv(a) {
        ...
        this.a = new bm;
        this.wa = {Point: this.Dm, LineString: this.ih, LinearRing: this.ih, Polygon: this.Em, MultiPoint: this.Bm, MultiLineString: this.Am, MultiPolygon: this.Cm,
    ...
    l.ih = function (a, c) {
        ...
        e = 0;
        for (f = d.length - 1; e < f; ++e)
            g = d.slice(e, e + 2), h = {feature: a, la: g}, this.a.za(Vb(g), h)
    };
    l.Am = function (a, c) {
        var d = c.Z(), e, f, g, h, k, m, n;
        h = 0;
        for (k = d.length; h < k; ++h)
            for (e = d[h], f = 0, g = e.length - 1; f < g; ++f)
                m = e.slice(f, f + 2), n = {feature: a, la: m}, this.a.za(Vb(m), n)
    };
    l.Bm = function (a, c) {
        var d = c.Z(), e, f, g;
        f = 0;
        for (g = d.length; f < g; ++f)
            e = d[f], e = {feature: a, la: [e, e]}, this.a.za(c.O(), e)
    };
    l.Cm = function (a, c) {
        var d = c.Z(), e, f, g, h, k, m, n, p, q, r;
        m = 0;
        for (n = d.length; m < n; ++m)
            for (p = d[m], h = 0, k = p.length; h < k; ++h)
                for (e = p[h], f = 0, g = e.length - 1; f < g; ++f)
                    q = e.slice(f, f + 2), r = {feature: a, la: q}, this.a.za(Vb(q), r)
    };
    l.Dm = function (a, c) {
    ...
    function Tv(a) {
        ...
        if (0 < h.length) {
            ...
            h = h[0].la;
            if (this.na && !this.T) {
                if (e = c.Da(h[0]), k = c.Da(h[1]), e = Sb(d, e), d = Sb(d, k), k = Math.sqrt(Math.min(e, d)), k = k <= this.c)
                    f = !0, m = e > d ? h[1] : h[0], g = c.Da(m)
            } else
                this.T && (m = Nb(e, h), g = c.Da(m), Math.sqrt(Sb(d, g)) <= this.c && (f = !0, this.na && (e = c.Da(h[0]), k = c.Da(h[1]), e = Sb(g, e), d = Sb(g, k), k = Math.sqrt(Math.min(e,
    ...
    l.Hk = function () {
        for (var a = this.Bg(), c = Mg(1, 256), d = c.createLinearGradient(0, 0, 1, 256), e = 1 / (a.length - 1), f = 0, g = a.length; f < g; ++f)
    ...
    l.$k = function (a) {
        ...
        for (f = d.length; e < f; e += 4)
            if (g = 4 * d[e + 3])
                d[e] = this.f[g], d[e + 1] = this.f[g + 1], d[e + 2] = this.f[g + 2];
        a.putImageData(c, 0, 0)
    };
    l.Zh = function (a) {
        this.set("blur", a)
    ...
    function ew(a, c, d, e, f, g, h, k, m, n, p) {
        ...
        if (0 === pc(g))
            this.state = 4;
        else if ((k = a.O()) && (f ? f = vc(f, k) : f = k), e = e.$(this.U[0]), e = jl(a, d, tc(g), e), !isFinite(e) || 0 >= e)
            this.state = 4;
        else if (this.B = new ml(a, d, g, f, e * (void 0 !== n ? n : .5)), 0 === this.B.f.length)
            this.state = 4;
            ...
            if (a = bg(c, d, this.s), 100 > (a.a - a.b + 1) * (a.f - a.g + 1)) {
                for (c = a.b; c <= a.a; c++)
                    for (d = a.g; d <= a.f; d++)
                        (n = m(this.s, c, d, h)) && this.g.push(n);
            ...
            this.g.forEach(function (c) {
                ...
                if (0 == d || 1 == d) {
                    ...
                    e = C(c, "change", function () {
                        var d = c.V();
                        if (2 == d || 3 == d || 4 == d)
                            Xa(e), a--, 0 === a && (this.Rc.forEach(Xa), this.Rc = null, this.ud())
                    }, this);
                    this.Rc.push(e)
                }
            }, this);
    ...
    function X(a) {
        zm.call(this, {attributions: a.attributions, cacheSize: a.cacheSize, extent: a.extent, logo: a.logo, opaque: a.opaque, projection: a.projection, state: a.state, tileGrid: a.tileGrid, tileLoadFunction: a.tileLoadFunction ? a.tileLoadFunction : fw, tilePixelRatio: a.tilePixelRatio, tileUrlFunction: a.tileUrlFunction, url: a.url, urls: a.urls, wrapX: a.wrapX});
    ...
    function hw(a, c, d, e, f, g) {
        ...
        if (Lf(a.a, k)) {
            ...
            h = gw(a, c, d, e, f, g, m), a.a.set(k, h);
        return h
    }
    l.lb = function (a) {
        if (this.M != a) {
    ...
    ;
    function iw(a) {
        X.call(this, {cacheSize: a.cacheSize, crossOrigin: "anonymous", opaque: !0, projection: Ic("EPSG:3857"), reprojectionErrorThreshold: a.reprojectionErrorThreshold, state: "loading", tileLoadFunction: a.tileLoadFunction, wrapX: void 0 !== a.wrapX ? a.wrapX : !0});
    ...
    iw.prototype.v = function (a) {
        if (200 != a.statusCode || "OK" != a.statusDescription || "ValidCredentials" != a.authenticationResultCode || 1 != a.resourceSets.length || 1 != a.resourceSets[0].resources.length)
            ...
            a = ig(this.f);
            var f = kg({extent: a, minZoom: d.zoomMin, maxZoom: e, tileSize: d.imageWidth == d.imageHeight ? d.imageWidth : [d.imageWidth, d.imageHeight]});
            this.tileGrid =
                    f;
            var g = this.j;
            this.tileUrlFunction = wm(d.imageUrlSubdomains.map(function (a) {
                ...
                return function (a) {
                    if (a)
                        return Mf(a[0], a[1], -a[2] - 1, c), e.replace("{quadkey}", Nf(c))
                }
            }));
    ...
    function kw(a) {
        a = a || {};
        var c = void 0 !== a.projection ? a.projection : "EPSG:3857", d = void 0 !== a.tileGrid ? a.tileGrid : kg({extent: ig(c), maxZoom: a.maxZoom, minZoom: a.minZoom, tileSize: a.tileSize});
    ...
    function lw(a) {
        ...
        this.c = a.config || {};
        this.j = {};
        kw.call(this, {attributions: a.attributions, cacheSize: a.cacheSize, crossOrigin: a.crossOrigin, logo: a.logo, maxZoom: void 0 !== a.maxZoom ? a.maxZoom : 18, minZoom: a.minZoom, projection: a.projection, state: "loading", wrapX: a.wrapX});
        mw(this)
    }
    y(lw, kw);
    l = lw.prototype;
    ...
    function qw(a) {
        a = a || {};
        rl.call(this, {attributions: a.attributions, logo: a.logo, projection: a.projection, resolutions: a.resolutions});
    ...
    l.Hc = function (a, c, d, e) {
        ...
        c = sl(this, c);
        var f = this.c;
        if (f && this.T == this.g && f.$() == c && f.f == d && cc(f.O(), a))
            return f;
    ...
    l.Hc = function (a, c, d) {
        ...
        d = this.ea ? d : 1;
        var e = this.i;
        if (e && this.S == this.g && e.$() == c && e.f == d && cc(e.O(), a))
            return e;
        1 != this.v && (a = a.slice(), yc(a, this.v));
        var f = [rc(a) / c * d, sc(a) / c * d];
        if (void 0 !== this.T) {
            var e = this.T, g = tc(a), h = this.ta, k = rc(a), m = sc(a), n = f[0], p = f[1], q = .0254 / this.s, f = {OPERATION: this.xa ? "GETDYNAMICMAPOVERLAYIMAGE" : "GETMAPIMAGE", VERSION: "2.0.0", LOCALE: "en", CLIENTAGENT: "ol.source.ImageMapGuide source", CLIP: "1", SETDISPLAYDPI: this.s, SETDISPLAYWIDTH: Math.round(f[0]), SETDISPLAYHEIGHT: Math.round(f[1]),
    ...
    l.$m = function (a, c, d, e) {
        if (void 0 !== this.j) {
            var f = uc(a, c, 0, vw), g = {SERVICE: "WMS", VERSION: "1.3.0", REQUEST: "GetFeatureInfo", FORMAT: "image/png", TRANSPARENT: !0, QUERY_LAYERS: this.i.LAYERS};
            Pa(g, this.i, e);
    ...
    l.Hc = function (a, c, d, e) {
        ...
        if (m && this.Y == this.g && m.$() == c && m.f == d && cc(m.O(), a))
            return m;
        if (1 != this.s) {
    ...
    function xw(a) {
        ...
        kw.call(this, {attributions: c, cacheSize: a.cacheSize, crossOrigin: void 0 !== a.crossOrigin ? a.crossOrigin : "anonymous", opaque: void 0 !== a.opaque ? a.opaque : !0, maxZoom: void 0 !== a.maxZoom ? a.maxZoom : 19, reprojectionErrorThreshold: a.reprojectionErrorThreshold, tileLoadFunction: a.tileLoadFunction, url: void 0 !== a.url ? a.url : "https://{a-c}.tile.openstreetmap.org/{z}/{x}/{y}.png", wrapX: a.wrapX})
    }
    y(xw, kw);
    ...
    function zw(a) {
        ...
        var c = Aw[a.layer];
        this.c = a.layer;
        kw.call(this, {attributions: c.attributions, cacheSize: a.cacheSize, crossOrigin: "anonymous", logo: "https://developer.mapquest.com/content/osm/mq_logo.png", maxZoom: c.maxZoom, reprojectionErrorThreshold: a.reprojectionErrorThreshold, opaque: c.opaque, tileLoadFunction: a.tileLoadFunction, url: void 0 !== a.url ? a.url : "https://otile{1-4}-s.mqcdn.com/tiles/1.0.0/" + this.c + "/{z}/{x}/{y}.jpg"})
    }
    y(zw, kw);
    var Bw = new ue({html: 'Tiles Courtesy of <a href="http://www.mapquest.com/">MapQuest</a>'}), Aw = {osm: {maxZoom: 19, opaque: !0, attributions: [Bw, yw]}, sat: {maxZoom: 18, opaque: !0, attributions: [Bw, new ue({html: "Portions Courtesy NASA/JPL-Caltech and U.S. Depart. of Agriculture, Farm Service Agency"})]}, hyb: {maxZoom: 18, opaque: !1, attributions: [Bw, yw]}};
            ...
            return function e(a, c, h) {
                ...
                return k
                        ...
                        function g(a) {
                            ...
                            return function (e) {
                                ...
                                if (e.imageOps) {
                                    ...
                                    A = Array(m);
                                    for (e = 0; e < m; ++e)
                                        k[e] = new Uint8ClampedArray(f[e]), A[e] = [0, 0, 0, 0];
                                    for (f = 0; f < n; f += 4) {
                                        for (e = 0; e < m; ++e)
                                            G = k[e], A[e][0] = G[f], A[e][1] = G[f + 1], A[e][2] = G[f + 2], A[e][3] = G[f + 3];
                                        e = a(A, g);
                                        h[f] = e[0];
                                        h[f + 1] = e[1];
                                        h[f + 2] = e[2];
                        ...
                        function m(a) {
                            ...
                            if (c)
                                for (var f = 0; f < c; ++f)
                                    e[f] = h(a, this.eg.bind(this, f));
                            else
                                e[0] = k(a, this.eg.bind(this, 0));
                            this.Gd = e;
                            this.Vc = [];
                        ...
                        m.prototype.gj = function (a) {
                            for (this.Vc.push(a); this.Vc.length > this.jj; )
                                this.Vc.shift().mg(null, null)
                        };
                        m.prototype.bg = function () {
                            if (0 === this.Ed && 0 < this.Vc.length) {
                                ...
                                this.Ed = g;
                                if (1 === g)
                                    this.Gd[0].postMessage({buffers: f, meta: a.Sg, imageOps: this.Ne, width: c, height: e}, f);
                                else
                                    for (var h = 4 * Math.ceil(a.vc[0].data.length / 4 / g), k = 0; k < g; ++k) {
                                        for (var m = k * h, n = [], A = 0, G = f.length; A < G; ++A)
                                            n.push(f[k].slice(m, m + h));
                                        this.Gd[k].postMessage({buffers: n, meta: a.Sg, imageOps: this.Ne, width: c, height: e}, n)
                                    }
                            }
                        };
                        ...
                        m.prototype.kj = function () {
                            ...
                            if (1 === c)
                                e = new Uint8ClampedArray(this.Dc[0].buffer),
                                        f = this.Dc[0].meta;
                            else {
    ...
    function Cw(a) {
        ...
        for (var c = Ew(this.c), d = {}, e = 0, f = c.length; e < f; ++e)
            d[w(c[e].layer)] = c[e];
        this.j = this.s = null;
        this.Y = {animate: !1, attributions: {}, coordinateToPixelMatrix: hd(), extent: null, focus: null, index: 0, layerStates: d, layerStatesArray: c, logos: {},
            pixelRatio: 1, pixelToCoordinateMatrix: hd(), postRenderFunctions: [], size: [0, 0], skippedFeatureUids: {}, tileQueue: this.ea, time: Date.now(), usedTiles: {}, viewState: {rotation: 0}, viewHints: [], wantedTiles: {}};
        rl.call(this, {});
    ...
    var Kw = {terrain: {sb: "jpg", opaque: !0}, "terrain-background": {sb: "jpg", opaque: !0}, "terrain-labels": {sb: "png", opaque: !1}, "terrain-lines": {sb: "png", opaque: !1}, "toner-background": {sb: "png", opaque: !0}, toner: {sb: "png", opaque: !0}, "toner-hybrid": {sb: "png", opaque: !1}, "toner-labels": {sb: "png", opaque: !1}, "toner-lines": {sb: "png", opaque: !1}, "toner-lite": {sb: "png", opaque: !0}, watercolor: {sb: "jpg", opaque: !0}}, Lw = {terrain: {minZoom: 4, maxZoom: 18}, toner: {minZoom: 0, maxZoom: 20}, watercolor: {minZoom: 1, maxZoom: 16}};
    function Mw(a) {
        var c = a.layer.indexOf("-"), c = -1 == c ? a.layer : a.layer.slice(0, c), c = Lw[c], d = Kw[a.layer];
        kw.call(this, {attributions: Nw, cacheSize: a.cacheSize, crossOrigin: "anonymous", maxZoom: c.maxZoom, minZoom: c.minZoom, opaque: d.opaque, reprojectionErrorThreshold: a.reprojectionErrorThreshold, tileLoadFunction: a.tileLoadFunction, url: void 0 !== a.url ? a.url : "https://stamen-tiles-{a-d}.a.ssl.fastly.net/" + a.layer + "/{z}/{x}/{y}." + d.sb})
    }
    y(Mw, kw);
    ...
    function Qw(a) {
        lg.call(this, {opaque: !1, projection: a.projection, tileGrid: a.tileGrid, wrapX: void 0 !== a.wrapX ? a.wrapX : !0})
    }
    y(Qw, lg);
    ...
    function Rw(a) {
        this.c = null;
        X.call(this, {attributions: a.attributions, cacheSize: a.cacheSize, crossOrigin: a.crossOrigin, projection: Ic("EPSG:3857"), reprojectionErrorThreshold: a.reprojectionErrorThreshold, state: "loading", tileLoadFunction: a.tileLoadFunction, wrapX: void 0 !== a.wrapX ? a.wrapX : !0});
        if (a.jsonp)
            dw(a.url, this.th.bind(this), this.he.bind(this));
        else {
    ...
    function Sw(a) {
        ...
        if (a.url)
            if (this.c)
                dw(a.url, this.xf.bind(this), this.ie.bind(this));
            else {
                var c = new XMLHttpRequest;
    ...
    function Vw(a) {
        if (0 == a.state)
            if (a.state = 1, a.v)
                dw(a.s, a.uh.bind(a), a.Vd.bind(a));
            else {
                var c = new XMLHttpRequest;
    ...
    function ax(a) {
        this.l = a.matrixIds;
        Yf.call(this, {extent: a.extent, origin: a.origin, origins: a.origins, resolutions: a.resolutions, tileSize: a.tileSize, tileSizes: a.tileSizes, sizes: a.sizes})
    }
    y(ax, Yf);
    ...
    function Z(a) {
        ...
        var e = this.Y = void 0 !== a.requestEncoding ? a.requestEncoding : "KVP", f = a.tileGrid, g = {layer: this.B, style: this.S, tilematrixset: this.j};
        "KVP" == e && Pa(g, {Service: "WMTS", Request: "GetTile", Version: this.T, Format: this.v});
        var h = this.c, k = d && 0 < d.length ? wm(d.map(c)) : xm;
        X.call(this, {attributions: a.attributions, cacheSize: a.cacheSize, crossOrigin: a.crossOrigin, logo: a.logo, projection: a.projection, reprojectionErrorThreshold: a.reprojectionErrorThreshold, tileClass: a.tileClass,
    ...
    function dx(a) {
        ...
        X.call(this, {attributions: a.attributions, cacheSize: a.cacheSize, crossOrigin: a.crossOrigin, logo: a.logo, reprojectionErrorThreshold: a.reprojectionErrorThreshold, tileClass: ex, tileGrid: c, tileUrlFunction: function (a) {
                if (a) {
                    var c = a[0], d = a[1];
                    a = -a[2] - 1;
    ...
    function jx(a) {
        ...
        this.a && (h = He(this.a.b), k = this.a.a, void 0 === k && (k = 1), g = this.a.g, Zg || (g = null), e = this.a.c, void 0 === e && (e = "round"), d = this.a.f, void 0 === d && (d = "round"), f = this.a.i, void 0 ===
                f && (f = 10));
        var m = 2 * (this.g + k) + 1, d = {strokeStyle: h, wd: k, size: m, lineCap: d, lineDash: g, lineJoin: e, miterLimit: f};
        if (void 0 === c) {
            var n = Mg(m, m);
            this.s = n.canvas;
            c = m = this.s.width;
            ...
            m = Math.round(m), (e = !this.o) && (n = this.Ch.bind(this, d)), f = this.a ? hk(this.a) : "-", g = this.o ? bk(this.o) : "-", this.f && f == this.f[1] && g == this.f[2] && this.g == this.f[3] && this.c == this.f[4] && this.l == this.f[5] && this.b == this.f[6] || (this.f = ["r" + f + g + (void 0 !==
        ...
        this.ya = [m, m];
        this.R = [c, c];
        ti.call(this, {opacity: 1, rotateWithView: void 0 !== a.rotateWithView ? a.rotateWithView : !1, rotation: void 0 !== a.rotation ? a.rotation : 0, scale: 1, snapToPixel: void 0 !==
    ...
    l.Dh = function (a, c, d, e) {
        ...
        for (d = 0; d <= this.b; d++)
            e = 2 * d * Math.PI / this.b - Math.PI / 2 + this.l, f = 0 === d % 2 ? this.g : this.c, c.lineTo(a.size / 2 + f * Math.cos(e), a.size / 2 + f * Math.sin(e));
    ...
    l.Ch = function (a, c, d, e) {
        ...
        var f;
        for (d = 0; d <= this.b; d++)
            f = 2 * d * Math.PI / this.b - Math.PI / 2 + this.l, e = 0 === d % 2 ? this.g : this.c, c.lineTo(a.size / 2 + e * Math.cos(f), a.size / 2 + e * Math.sin(f));
        c.fillStyle = Wj;
        c.fill();
    ...
    t("ol.source.WMTS.optionsFromCapabilities", function (a, c) {
        ...
        return{urls: u, layer: c.layer, matrixSet: g, format: h, projection: n, requestEncoding: q, tileGrid: m, style: f, dimensions: k, wrapX: r}
    }, OPENLAYERS);
